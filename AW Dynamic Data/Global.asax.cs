		...
		public static void RegisterRoutes(RouteCollection routes)
		{
			...
			SD.LLBLGen.Pro.DynamicDataSupportClasses.LLBLGenProDataModelProvider modelProvider =
							 new SD.LLBLGen.Pro.DynamicDataSupportClasses.LLBLGenProDataModelProvider(
										 typeof(AW.Data.EntityType),							// <<<<< Replace 'YourRootNamespace' with the namespace you specified for Root namespace when you generated code
										 new AW.Data.Linq.LinqMetaData(),						// <<<<< Replace 'YourRootNamespace' with the namespace you specified for Root namespace when you generated code
										 new AW.Data.FactoryClasses.ElementCreator());		// <<<<< Replace 'YourRootNamespace' with the namespace you specified for Root namespace when you generated code
