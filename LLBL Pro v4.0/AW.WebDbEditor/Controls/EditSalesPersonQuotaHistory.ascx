...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditSalesPersonQuotaHistory.ascx.cs" Inherits="Controls_EditSalesPersonQuotaHistory" %>
<llblgenpro:LLBLGenProDataSource ID="_SalesPersonQuotaHistoryDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.SalesPersonQuotaHistoryCollection, AW.Data" LivePersistence="False" OnPerformSelect="_SalesPersonQuotaHistoryDS_PerformSelect" OnPerformWork="_SalesPersonQuotaHistoryDS_PerformWork"/>
<asp:FormView ID="frmEditSalesPersonQuotaHistory" DataKeyNames="QuotaDate, SalesPersonID" runat="server" DefaultMode="insert" DataSourceID="_SalesPersonQuotaHistoryDS" Cellpadding="0" OnItemCommand="frmEditSalesPersonQuotaHistory_ItemCommand" OnItemCreated="frmEditSalesPersonQuotaHistory_ItemCreated">
<InsertItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<cc:datetextbox id="dtxQuotaDate" runat="server" Required="True" Value='<%# Bind("QuotaDate") %>' ValidationGroup="InsertValidations" /> *  <asp:RequiredFieldValidator ValidationGroup="InsertValidations" ID="reqQuotaDate" runat="server" ControlToValidate="dtxQuotaDate" Display="Dynamic" ErrorMessage="Required" />
		...
		<tr>
			...
			<td class="content">
				<asp:textbox id="tbxSalesQuota" runat="server" ValidationGroup="InsertValidations" Text='<%# Bind("SalesQuota") %>'  CssClass="required"/> *  <asp:RequiredFieldValidator ValidationGroup="InsertValidations" ID="reqSalesQuota" runat="server" ControlToValidate="tbxSalesQuota" Display="Dynamic" ErrorMessage="Required" />
...
<EditItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:Label ID="lblQuotaDate" runat="server" Text='<%# Bind("QuotaDate", "{0:dd-MMM-yyyy}") %>'/>			</td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td class="content">
				<asp:Label ID="lblSalesPersonID" runat="server" Text='<%# Bind("SalesPersonID") %>'/>			</td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td class="content">
				<asp:textbox id="tbxSalesQuota" runat="server" ValidationGroup="EditValidations" Text='<%# Bind("SalesQuota") %>'  CssClass="required"/> *  <asp:RequiredFieldValidator ValidationGroup="EditValidations" ID="reqSalesQuota" runat="server" ControlToValidate="tbxSalesQuota" Display="Dynamic" ErrorMessage="Required" />
...
<ItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			...
			<td class="content" width="100%">
			<asp:Label ID="lblQuotaDate" runat="server" Text='<%# Bind("QuotaDate", "{0:mm/dd/yyyy}") %>'/></td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
		<tr>
			<td width="20"  nowrap="nowrap" class="content">&nbsp;</td>
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this SalesPersonQuotaHistory instance with PK values: "  + "QuotaDate: " + Eval("QuotaDate") + "SalesPersonID: " + Eval("SalesPersonID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
