...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditTransactionHistoryArchive.ascx.cs" Inherits="Controls_EditTransactionHistoryArchive" %>
<llblgenpro:LLBLGenProDataSource ID="_TransactionHistoryArchiveDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.TransactionHistoryArchiveCollection, AW.Data" LivePersistence="False" OnPerformSelect="_TransactionHistoryArchiveDS_PerformSelect" OnPerformWork="_TransactionHistoryArchiveDS_PerformWork"/>
<asp:FormView ID="frmEditTransactionHistoryArchive" DataKeyNames="TransactionID" runat="server" DefaultMode="insert" DataSourceID="_TransactionHistoryArchiveDS" Cellpadding="0" OnItemCommand="frmEditTransactionHistoryArchive_ItemCommand" OnItemCreated="frmEditTransactionHistoryArchive_ItemCreated">
<InsertItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:textbox id="tbxTransactionID" runat="server" maxlength="11" size="11" Text='<%# Bind("TransactionID") %>' ValidationGroup="InsertValidations"  CssClass="required"/> * <asp:RangeValidator ID="valTransactionID" runat="server" ControlToValidate="tbxTransactionID" ValidationGroup="InsertValidations" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="InsertValidations" ID="reqTransactionID" runat="server" ControlToValidate="tbxTransactionID" Display="Dynamic" ErrorMessage="Required" />
		...
		<tr>
			...
			<td class="content">
				<asp:textbox id="tbxTransactionType" runat="server" maxlength="1" size="1" Text='<%# Bind("TransactionType") %>' ValidationGroup="InsertValidations"  CssClass="required"/> *  <asp:RequiredFieldValidator ValidationGroup="InsertValidations" ID="reqTransactionType" runat="server" ControlToValidate="tbxTransactionType" Display="Dynamic" ErrorMessage="Required" />
...
<EditItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:textbox id="tbxTransactionType" runat="server" maxlength="1" size="1" Text='<%# Bind("TransactionType") %>' ValidationGroup="EditValidations"  CssClass="required"/> *  <asp:RequiredFieldValidator ValidationGroup="EditValidations" ID="reqTransactionType" runat="server" ControlToValidate="tbxTransactionType" Display="Dynamic" ErrorMessage="Required" />
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this TransactionHistoryArchive instance with PK values: "  + "TransactionID: " + Eval("TransactionID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
