...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListProductModelInstances.ascx.cs" Inherits="Controls_ListProductModelInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="ProductModelID" 
					DataSourceID="_ProductModelDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
		...
		<asp:TemplateField HeaderText="ProductModelID" SortExpression="ProductModelID" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" ItemStyle-CssClass="ColumnContent" ItemStyle-Wrap="false" >
			<ItemTemplate>
				<asp:Label ID="lblProductModelID" runat="server" Text='<%# Bind("ProductModelID") %>'/>
			</ItemTemplate>
		</asp:TemplateField>
