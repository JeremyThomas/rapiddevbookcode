<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchProductModelProductDescriptionCulture.ascx.cs" Inherits="Controls_SearchProductModelProductDescriptionCulture" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxProductDescriptionID" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valProductDescriptionID" runat="server" ControlToValidate="tbxProductDescriptionID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqProductDescriptionID" runat="server" ControlToValidate="tbxProductDescriptionID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxProductModelID" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valProductModelID" runat="server" ControlToValidate="tbxProductModelID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqProductModelID" runat="server" ControlToValidate="tbxProductModelID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableProductDescriptionID" runat="server" /></td>
		<td class="formtexts tableborder">
			ProductDescriptionID:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotProductDescriptionID" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opProductDescriptionID" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="1" Text="Greater"/>
				<asp:ListItem Value="2" Text="Greater / Equal"/>
				<asp:ListItem Value="3" Text="Lesser"/>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxProductDescriptionIDMiFrom" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiProductDescriptionIDMiFrom" runat="server" ControlToValidate="tbxProductDescriptionIDMiFrom" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
			and
			<asp:textbox id="tbxProductDescriptionIDMiTo" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiProductDescriptionIDMiTo" runat="server" ControlToValidate="tbxProductDescriptionIDMiTo" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
		</td>
	</tr>
	<tr>
