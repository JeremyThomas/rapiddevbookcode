  ...
  using AW.Data.HelperClasses;
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public static  EmployeeEntity FetchPolymorphic(ITransaction transactionToUse, System.Int32 employeeID, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			fields.ForcedValueWrite((int)EmployeeFieldIndex.EmployeeID, employeeID);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _manager, new PropertyChangedEventHandler( OnManagerPropertyChanged ), "Manager", AW.Data.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIDManagerIDStatic, true, signalRelatedEntity, "Manages", resetFKFields, new int[] { (int)EmployeeFieldIndex.ManagerID } );		
			_manager = null;
		}
		...
		private void SetupSyncManager(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _manager, new PropertyChangedEventHandler( OnManagerPropertyChanged ), "Manager", AW.Data.RelationClasses.StaticEmployeeRelations.EmployeeEntityUsingEmployeeIDManagerIDStatic, true, ref _alreadyFetchedManager, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _contact, new PropertyChangedEventHandler( OnContactPropertyChanged ), "Contact", AW.Data.RelationClasses.StaticEmployeeRelations.ContactEntityUsingContactIDStatic, true, signalRelatedEntity, "Employees", resetFKFields, new int[] { (int)EmployeeFieldIndex.ContactID } );		
			_contact = null;
		}
		...
		private void SetupSyncContact(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _contact, new PropertyChangedEventHandler( OnContactPropertyChanged ), "Contact", AW.Data.RelationClasses.StaticEmployeeRelations.ContactEntityUsingContactIDStatic, true, ref _alreadyFetchedContact, new string[] {  } );
			}
		}
