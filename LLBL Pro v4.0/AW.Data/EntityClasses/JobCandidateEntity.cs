...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return FetchUsingPK(jobCandidateID, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 jobCandidateID, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(jobCandidateID, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 jobCandidateID, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(jobCandidateID, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 jobCandidateID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(jobCandidateID, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.JobCandidateID, null, null, null);
		}
		...
		public virtual EmployeeEntity GetSingleEmployee(bool forceFetch)
		{
			if( ( !_alreadyFetchedEmployee || forceFetch || _alwaysFetchEmployee) && !this.IsSerializing && !this.IsDeserializing  && !this.InDesignMode)			
			{
				...
				{
					newEntity = EmployeeEntity.FetchPolymorphic(this.Transaction, this.EmployeeID.GetValueOrDefault(), this.ActiveContext);
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int32 jobCandidateID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(jobCandidateID, prefetchPathToUse, null, null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AW.Data.RelationClasses.StaticJobCandidateRelations.EmployeeEntityUsingEmployeeIDStatic, true, signalRelatedEntity, "JobCandidates", resetFKFields, new int[] { (int)JobCandidateFieldIndex.EmployeeID } );		
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AW.Data.RelationClasses.StaticJobCandidateRelations.EmployeeEntityUsingEmployeeIDStatic, true, ref _alreadyFetchedEmployee, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 jobCandidateID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)JobCandidateFieldIndex.JobCandidateID].ForcedCurrentValueWrite(jobCandidateID);
		...
		public virtual System.String Resume
		{
			...
			set	{ SetValue((int)JobCandidateFieldIndex.Resume, value, true); }
		}
		...
		{ 
			get { return (int)AW.Data.EntityType.JobCandidateEntity; }
		}
