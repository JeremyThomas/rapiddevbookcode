...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ProductCostHistory'. <br/><br/>
	/// 
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ProductCostHistoryEntity(System.Int32 productID, System.DateTime startDate, IPrefetchPath prefetchPathToUse):base("ProductCostHistoryEntity")
		{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AW.Data.RelationClasses.StaticProductCostHistoryRelations.ProductEntityUsingProductIDStatic, true, signalRelatedEntity, "ProductCostHistories", resetFKFields, new int[] { (int)ProductCostHistoryFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AW.Data.RelationClasses.StaticProductCostHistoryRelations.ProductEntityUsingProductIDStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 productID, System.DateTime startDate, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)ProductCostHistoryFieldIndex.ProductID].ForcedCurrentValueWrite(productID);
				this.Fields[(int)ProductCostHistoryFieldIndex.StartDate].ForcedCurrentValueWrite(startDate);
		...
		{
			get	{ return new PrefetchPathElement(new AW.Data.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Product")[0], (int)AW.Data.EntityType.ProductCostHistoryEntity, (int)AW.Data.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
