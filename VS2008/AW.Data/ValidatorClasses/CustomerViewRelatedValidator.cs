...
// Code is generated on: Sunday, November 06, 2005 1:19:32 PM
...
{
	/// <summary>
	/// Implementation of the CustomerViewRelated Validator class. This class formulates validation rules for the
	/// CustomerViewRelatedEntity class. It is plugged into an instance of the CustomerViewRelatedEntity class using the Strategy
	...
	/// CustomerViewRelatedEntity class instead of an instance of this class. The CustomerViewRelatedEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class CustomerViewRelatedValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CustomerViewRelatedValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add CustomerViewRelatedValidator.Validate implementation
			return true ;
