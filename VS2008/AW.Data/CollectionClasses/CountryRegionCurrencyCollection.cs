...
namespace AW.Data.CollectionClasses
{
	...
	public partial class CountryRegionCurrencyCollection : EntityCollectionBase<CountryRegionCurrencyEntity>
	{
		...
		public CountryRegionCurrencyCollection(IList<CountryRegionCurrencyEntity> initialContents):base(new CountryRegionCurrencyEntityFactory())
		{
		...
		{
			return GetMultiManyToOne(countryRegionInstance, currencyInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(countryRegionInstance, currencyInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		public virtual bool GetMultiManyToOne(IEntity countryRegionInstance, IEntity currencyInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, filter, countryRegionInstance, currencyInstance, pageNumber, pageSize);
		}
		...
		{
			CountryRegionCurrencyDAO dao = DAOFactory.CreateCountryRegionCurrencyDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, countryRegionInstance, currencyInstance);
		}
