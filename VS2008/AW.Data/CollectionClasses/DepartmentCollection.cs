...
namespace AW.Data.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of DepartmentEntity objects. </summary>
	[Serializable]
	public partial class DepartmentCollection : EntityCollectionBase<DepartmentEntity>
	{
		/// <summary> CTor</summary>
		public DepartmentCollection():base(new DepartmentEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public DepartmentCollection(IList<DepartmentEntity> initialContents):base(new DepartmentEntityFactory())
		{
		...
		public DepartmentCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected DepartmentCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		public bool GetMultiManyToManyUsingEmployeeCollectionViaEmployeeDepartmentHistory(IEntity employeeInstance)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaEmployeeDepartmentHistory(employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaEmployeeDepartmentHistory(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaEmployeeDepartmentHistory(employeeInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaEmployeeDepartmentHistory(IEntity employeeInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaEmployeeDepartmentHistory(employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		public object GetScalar(DepartmentFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(DepartmentFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(DepartmentFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(DepartmentFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(DepartmentFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
