...
namespace AW.Data.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of ContactTypeEntity objects. </summary>
	[Serializable]
	public partial class ContactTypeCollection : EntityCollectionBase<ContactTypeEntity>
	{
		/// <summary> CTor</summary>
		public ContactTypeCollection():base(new ContactTypeEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public ContactTypeCollection(IList<ContactTypeEntity> initialContents):base(new ContactTypeEntityFactory())
		{
		...
		public ContactTypeCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected ContactTypeCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}



		/// <summary> Retrieves in this ContactTypeCollection object all ContactTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in ContactEntity. 
		...
		/// <summary> Retrieves in this ContactTypeCollection object all ContactTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in StoreEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this ContactTypeCollection object all ContactTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in VendorEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		public object GetScalar(ContactTypeFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(ContactTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(ContactTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(ContactTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(ContactTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
