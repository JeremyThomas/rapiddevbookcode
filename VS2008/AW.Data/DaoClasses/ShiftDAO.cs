...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class ShiftDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public ShiftDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "ShiftEntity", new ShiftEntityFactory())
		{
		}
		...
		internal ShiftDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
