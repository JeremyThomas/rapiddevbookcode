...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class SalesReasonDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public SalesReasonDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "SalesReasonEntity", new SalesReasonEntityFactory())
		{
		}
		...
		internal SalesReasonDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
