...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class JobCandidateDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public JobCandidateDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "JobCandidateEntity", new JobCandidateEntityFactory())
		{
		}
		...
		internal JobCandidateDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
