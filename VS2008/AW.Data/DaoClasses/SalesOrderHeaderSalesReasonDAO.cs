...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class SalesOrderHeaderSalesReasonDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public SalesOrderHeaderSalesReasonDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "SalesOrderHeaderSalesReasonEntity", new SalesOrderHeaderSalesReasonEntityFactory())
		{
		}
