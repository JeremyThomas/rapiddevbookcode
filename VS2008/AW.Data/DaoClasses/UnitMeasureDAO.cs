...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class UnitMeasureDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public UnitMeasureDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "UnitMeasureEntity", new UnitMeasureEntityFactory())
		{
		}
		...
		internal UnitMeasureDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		public bool GetMultiUsingProductCollectionViaBillOfMaterials_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.UnitMeasureEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(UnitMeasureEntity.Relations.BillOfMaterialsEntityUsingUnitMeasureCode, "BillOfMaterials_");
			relations.Add(BillOfMaterialsEntity.Relations.ProductEntityUsingProductAssemblyID, "BillOfMaterials_", string.Empty, JoinHint.None);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductCollectionViaBillOfMaterials_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.UnitMeasureEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(UnitMeasureEntity.Relations.BillOfMaterialsEntityUsingUnitMeasureCode, "BillOfMaterials_");
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductCollectionViaBillOfMaterials(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.UnitMeasureEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(UnitMeasureEntity.Relations.BillOfMaterialsEntityUsingUnitMeasureCode, "BillOfMaterials_");
			relations.Add(BillOfMaterialsEntity.Relations.ProductEntityUsingComponentID, "BillOfMaterials_", string.Empty, JoinHint.None);
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(productInstance.Fields[(int)ProductFieldIndex.ProductID], ComparisonOperator.Equal));
			return GetMulti(containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, entityFactoryToUse, selectFilter, relations, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductCollectionViaBillOfMaterials(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.UnitMeasureEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(UnitMeasureEntity.Relations.BillOfMaterialsEntityUsingUnitMeasureCode, "BillOfMaterials_");
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductModelCollectionViaProduct_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productModelInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.UnitMeasureEntity);
			RelationCollection relations = new RelationCollection();
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductModelCollectionViaProduct_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productModelInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.UnitMeasureEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(UnitMeasureEntity.Relations.ProductEntityUsingWeightUnitMeasureCode, "Product_");
		...
		public bool GetMultiUsingProductModelCollectionViaProduct(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productModelInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.UnitMeasureEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(UnitMeasureEntity.Relations.ProductEntityUsingSizeUnitMeasureCode, "Product_");
			relations.Add(ProductEntity.Relations.ProductModelEntityUsingProductModelID, "Product_", string.Empty, JoinHint.None);
			IPredicateExpression selectFilter = new PredicateExpression();
			selectFilter.Add(new FieldCompareValuePredicate(productModelInstance.Fields[(int)ProductModelFieldIndex.ProductModelID], ComparisonOperator.Equal));
			return GetMulti(containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, entityFactoryToUse, selectFilter, relations, pageNumber, pageSize);
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductSubcategoryCollectionViaProduct_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productSubcategoryInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.UnitMeasureEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(UnitMeasureEntity.Relations.ProductEntityUsingWeightUnitMeasureCode, "Product_");
