...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class SalesTaxRateDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public SalesTaxRateDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "SalesTaxRateEntity", new SalesTaxRateEntityFactory())
		{
		}
		...
		internal SalesTaxRateDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
