...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class CultureDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public CultureDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "CultureEntity", new CultureEntityFactory())
		{
		}
		...
		internal CultureDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.CultureEntity);
