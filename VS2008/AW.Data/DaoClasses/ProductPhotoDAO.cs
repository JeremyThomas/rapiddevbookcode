...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class ProductPhotoDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public ProductPhotoDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "ProductPhotoEntity", new ProductPhotoEntityFactory())
		{
		}
		...
		internal ProductPhotoDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductCollectionViaProductProductPhoto(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ProductPhotoEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(ProductPhotoEntity.Relations.ProductProductPhotoEntityUsingProductPhotoID, "ProductProductPhoto_");
