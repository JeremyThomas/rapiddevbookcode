...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class SalesPersonQuotaHistoryDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public SalesPersonQuotaHistoryDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "SalesPersonQuotaHistoryEntity", new SalesPersonQuotaHistoryEntityFactory())
		{
		}
		...
		internal SalesPersonQuotaHistoryDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(IEntity salesPersonInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)SalesPersonQuotaHistoryFieldIndex.SalesPersonID], ComparisonOperator.Equal, ((SalesPersonEntity)salesPersonInstance).SalesPersonID));
			}
			return selectFilter;
		}
