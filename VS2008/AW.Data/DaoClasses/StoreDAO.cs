...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class StoreDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public StoreDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "StoreEntity", new StoreEntityFactory())
		{
		}
		...
		internal StoreDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(IEntity salesPersonInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)StoreFieldIndex.SalesPersonID], ComparisonOperator.Equal, ((SalesPersonEntity)salesPersonInstance).SalesPersonID));
			}
			return selectFilter;
		}
