...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class CustomerAddressDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public CustomerAddressDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "CustomerAddressEntity", new CustomerAddressEntityFactory())
		{
		}
		...
		internal CustomerAddressDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
