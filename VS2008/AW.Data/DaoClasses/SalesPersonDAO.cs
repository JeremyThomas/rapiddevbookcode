...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class SalesPersonDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public SalesPersonDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "SalesPersonEntity", new SalesPersonEntityFactory())
		{
		}
		...
		internal SalesPersonDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		public bool GetMultiUsingAddressCollectionViaSalesOrderHeader_(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity addressInstance, int pageNumber, int pageSize)
		{
			...
			relations.Add(SalesPersonEntity.Relations.SalesOrderHeaderEntityUsingSalesPersonID, "SalesOrderHeader_");
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingSalesTerritoryCollectionViaSalesTerritoryHistory(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity salesTerritoryInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.SalesPersonEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(SalesPersonEntity.Relations.SalesTerritoryHistoryEntityUsingSalesPersonID, "SalesTerritoryHistory_");
			relations.Add(SalesTerritoryHistoryEntity.Relations.SalesTerritoryEntityUsingTerritoryID, "SalesTerritoryHistory_", string.Empty, JoinHint.None);
			IPredicateExpression selectFilter = new PredicateExpression();
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingSalesTerritoryCollectionViaSalesTerritoryHistory(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity salesTerritoryInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.SalesPersonEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(SalesPersonEntity.Relations.SalesTerritoryHistoryEntityUsingSalesPersonID, "SalesTerritoryHistory_");
