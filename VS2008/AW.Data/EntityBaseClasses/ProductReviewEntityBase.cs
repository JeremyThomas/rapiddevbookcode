...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>Entity base class which represents the base class for the entity 'ProductReview'.<br/><br/>
	/// 
	/// MS_Description: Customer reviews of products they have purchased.<br/>
	/// </summary>
	[Serializable]
	public abstract partial class ProductReviewEntityBase : CommonEntityBase, ISerializable
			...
			
	{
		...
		static ProductReviewEntityBase()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ProductReviewEntityBase()
		{
			InitClassEmpty(null);
		}
		...
		public ProductReviewEntityBase(System.Int32 productReviewID)
		{
			InitClassFetch(productReviewID, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="productReviewID">PK value for ProductReview which data should be fetched into this ProductReview object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public ProductReviewEntityBase(System.Int32 productReviewID, IPrefetchPath prefetchPathToUse)
		{
			InitClassFetch(productReviewID, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="productReviewID">PK value for ProductReview which data should be fetched into this ProductReview object</param>
		/// <param name="validator">The custom validator object for this ProductReviewEntity</param>
		public ProductReviewEntityBase(System.Int32 productReviewID, IValidator validator)
		{
			InitClassFetch(productReviewID, validator, null);
		}
		...
		protected ProductReviewEntityBase(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return ProductReviewEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Product":
					toReturn.Add(ProductReviewEntity.Relations.ProductEntityUsingProductID);
					break;
		...
		{
			return FetchUsingPK(productReviewID, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 productReviewID, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(productReviewID, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 productReviewID, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return Fetch(productReviewID, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 productReviewID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(productReviewID, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.ProductReviewID, null, null, null);
		}
		...
		public bool TestCurrentFieldValueForNull(ProductReviewFieldIndex fieldIndex)
		{
		...
		public virtual ProductEntity GetSingleProduct(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(ProductReviewEntity.Relations.ProductEntityUsingProductID);
		...
		{
			ProductReviewDAO dao = (ProductReviewDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ProductReviewEntity);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 productReviewID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(productReviewID, prefetchPathToUse, null, null);
		...
		{
			base.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductReviewEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "ProductReview", resetFKFields, new int[] { (int)ProductReviewFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductReviewEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 productReviewID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				IDao dao = this.CreateDAOInstance();
				base.Fields[(int)ProductReviewFieldIndex.ProductReviewID].ForcedCurrentValueWrite(productReviewID);
		...
		{
			return DAOFactory.CreateProductReviewDAO();
		}
		...
		public static IPrefetchPathElement PrefetchPathProduct
		{
			get
			{
				return new PrefetchPathElement(new AW.Data.CollectionClasses.ProductCollection(),
					(IEntityRelation)GetRelationsForField("Product")[0], (int)AW.Data.EntityType.ProductReviewEntity, (int)AW.Data.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return "ProductReviewEntity";}
		}
		...
		{
			get { return ProductReviewEntity.CustomProperties;}
		}
		...
		{
			get { return ProductReviewEntity.FieldsCustomProperties;}
		}
		...
		public virtual System.String ReviewerName
		{
			...
			set	{ SetValue((int)ProductReviewFieldIndex.ReviewerName, value, true); }
		}
		...
		{ 
			get { return (int)AW.Data.EntityType.ProductReviewEntity; }
		}
		#endregion
