...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>Entity base class which represents the base class for the entity 'TransactionHistory'.<br/><br/>
	/// 
	/// MS_Description: Record of each purchase order, sales order, or work order transaction year to date.<br/>
	/// </summary>
	[Serializable]
	public abstract partial class TransactionHistoryEntityBase : CommonEntityBase, ISerializable
			...
			
	{
		...
		static TransactionHistoryEntityBase()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public TransactionHistoryEntityBase()
		{
			InitClassEmpty(null);
		}
		...
		public TransactionHistoryEntityBase(System.Int32 transactionID)
		{
		...
		public TransactionHistoryEntityBase(System.Int32 transactionID, IPrefetchPath prefetchPathToUse)
		{
		...
		public TransactionHistoryEntityBase(System.Int32 transactionID, IValidator validator)
		{
		...
		protected TransactionHistoryEntityBase(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return TransactionHistoryEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Product":
					toReturn.Add(TransactionHistoryEntity.Relations.ProductEntityUsingProductID);
					break;
		...
		public bool TestCurrentFieldValueForNull(TransactionHistoryFieldIndex fieldIndex)
		{
		...
		public virtual ProductEntity GetSingleProduct(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(TransactionHistoryEntity.Relations.ProductEntityUsingProductID);
		...
		{
			TransactionHistoryDAO dao = (TransactionHistoryDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.TransactionHistoryEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", TransactionHistoryEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "TransactionHistory", resetFKFields, new int[] { (int)TransactionHistoryFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", TransactionHistoryEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 transactionID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)TransactionHistoryFieldIndex.TransactionID].ForcedCurrentValueWrite(transactionID);
		...
		public static IPrefetchPathElement PrefetchPathProduct
		{
			get
			{
				return new PrefetchPathElement(new AW.Data.CollectionClasses.ProductCollection(),
					(IEntityRelation)GetRelationsForField("Product")[0], (int)AW.Data.EntityType.TransactionHistoryEntity, (int)AW.Data.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return TransactionHistoryEntity.CustomProperties;}
		}
		...
		{
			get { return TransactionHistoryEntity.FieldsCustomProperties;}
		}
		...
		{ 
			get { return (int)AW.Data.EntityType.TransactionHistoryEntity; }
		}
		#endregion
