...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>Entity base class which represents the base class for the entity 'ProductCostHistory'.<br/><br/>
	/// 
	/// MS_Description: Changes in the cost of a product over time.<br/>
	/// </summary>
	[Serializable]
	public abstract partial class ProductCostHistoryEntityBase : CommonEntityBase, ISerializable
			...
			
	{
		...
		static ProductCostHistoryEntityBase()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ProductCostHistoryEntityBase()
		{
			InitClassEmpty(null);
		}
		...
		public ProductCostHistoryEntityBase(System.Int32 productID, System.DateTime startDate)
		{
		...
		public ProductCostHistoryEntityBase(System.Int32 productID, System.DateTime startDate, IPrefetchPath prefetchPathToUse)
		{
		...
		public ProductCostHistoryEntityBase(System.Int32 productID, System.DateTime startDate, IValidator validator)
		{
		...
		protected ProductCostHistoryEntityBase(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return ProductCostHistoryEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Product":
					toReturn.Add(ProductCostHistoryEntity.Relations.ProductEntityUsingProductID);
					break;
		...
		{
			return Fetch(productID, startDate, prefetchPathToUse, contextToUse, null);
		}
		...
		public bool TestCurrentFieldValueForNull(ProductCostHistoryFieldIndex fieldIndex)
		{
		...
		public virtual ProductEntity GetSingleProduct(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(ProductCostHistoryEntity.Relations.ProductEntityUsingProductID);
		...
		{
			ProductCostHistoryDAO dao = (ProductCostHistoryDAO)CreateDAOInstance();
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 productID, System.DateTime startDate, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(productID, startDate, prefetchPathToUse, null, null);
		...
		{
			base.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductCostHistoryEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "ProductCostHistory", resetFKFields, new int[] { (int)ProductCostHistoryFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductCostHistoryEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 productID, System.DateTime startDate, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)ProductCostHistoryFieldIndex.ProductID].ForcedCurrentValueWrite(productID);
				base.Fields[(int)ProductCostHistoryFieldIndex.StartDate].ForcedCurrentValueWrite(startDate);
		...
		{
			return DAOFactory.CreateProductCostHistoryDAO();
		}
		...
		public static IPrefetchPathElement PrefetchPathProduct
		{
			get
			{
				return new PrefetchPathElement(new AW.Data.CollectionClasses.ProductCollection(),
					(IEntityRelation)GetRelationsForField("Product")[0], (int)AW.Data.EntityType.ProductCostHistoryEntity, (int)AW.Data.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return "ProductCostHistoryEntity";}
		}
		...
		{
			get { return ProductCostHistoryEntity.CustomProperties;}
		}
		...
		{
			get { return ProductCostHistoryEntity.FieldsCustomProperties;}
		}
		...
		public virtual System.Int32 ProductID
		{
			...
			set	{ SetValue((int)ProductCostHistoryFieldIndex.ProductID, value, true); }
		}
		...
		public virtual System.DateTime StartDate
		{
			...
			set	{ SetValue((int)ProductCostHistoryFieldIndex.StartDate, value, true); }
		}
		...
		public virtual Nullable<System.DateTime> EndDate
		{
			...
			set	{ SetValue((int)ProductCostHistoryFieldIndex.EndDate, value, true); }
		}
		...
		public virtual System.Decimal StandardCost
		{
			...
			set	{ SetValue((int)ProductCostHistoryFieldIndex.StandardCost, value, true); }
		}
		...
		public virtual System.DateTime ModifiedDate
		{
			...
			set	{ SetValue((int)ProductCostHistoryFieldIndex.ModifiedDate, value, true); }
		}
		...
		{ 
			get { return (int)AW.Data.EntityType.ProductCostHistoryEntity; }
		}
		#endregion
