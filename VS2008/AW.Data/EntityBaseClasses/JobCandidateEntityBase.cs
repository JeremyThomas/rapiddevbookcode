...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>Entity base class which represents the base class for the entity 'JobCandidate'.<br/><br/>
	/// 
	/// MS_Description: Résumés submitted to Human Resources by job applicants.<br/>
	/// </summary>
	[Serializable]
	public abstract partial class JobCandidateEntityBase : CommonEntityBase, ISerializable
			...
			
	{
		...
		static JobCandidateEntityBase()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public JobCandidateEntityBase()
		{
			InitClassEmpty(null);
		}
		...
		public JobCandidateEntityBase(System.Int32 jobCandidateID)
		{
		...
		public JobCandidateEntityBase(System.Int32 jobCandidateID, IPrefetchPath prefetchPathToUse)
		{
		...
		public JobCandidateEntityBase(System.Int32 jobCandidateID, IValidator validator)
		{
		...
		protected JobCandidateEntityBase(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return JobCandidateEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Employee":
					toReturn.Add(JobCandidateEntity.Relations.EmployeeEntityUsingEmployeeID);
					break;
		...
		{
			return Fetch(jobCandidateID, prefetchPathToUse, contextToUse, null);
		}
		...
		public bool TestCurrentFieldValueForNull(JobCandidateFieldIndex fieldIndex)
		{
		...
		public virtual EmployeeEntity GetSingleEmployee(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(JobCandidateEntity.Relations.EmployeeEntityUsingEmployeeID);
		...
		{
			JobCandidateDAO dao = (JobCandidateDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.JobCandidateEntity);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 jobCandidateID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(jobCandidateID, prefetchPathToUse, null, null);
		...
		{
			base.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", JobCandidateEntity.Relations.EmployeeEntityUsingEmployeeID, true, signalRelatedEntity, "JobCandidate", resetFKFields, new int[] { (int)JobCandidateFieldIndex.EmployeeID } );		
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", JobCandidateEntity.Relations.EmployeeEntityUsingEmployeeID, true, ref _alreadyFetchedEmployee, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 jobCandidateID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)JobCandidateFieldIndex.JobCandidateID].ForcedCurrentValueWrite(jobCandidateID);
		...
		public static IPrefetchPathElement PrefetchPathEmployee
		{
			get
			{
				return new PrefetchPathElement(new AW.Data.CollectionClasses.EmployeeCollection(),
					(IEntityRelation)GetRelationsForField("Employee")[0], (int)AW.Data.EntityType.JobCandidateEntity, (int)AW.Data.EntityType.EmployeeEntity, 0, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return JobCandidateEntity.CustomProperties;}
		}
		...
		{
			get { return JobCandidateEntity.FieldsCustomProperties;}
		}
