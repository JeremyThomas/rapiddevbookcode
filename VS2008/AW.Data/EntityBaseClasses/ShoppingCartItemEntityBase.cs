...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>Entity base class which represents the base class for the entity 'ShoppingCartItem'.<br/><br/>
	/// 
	/// MS_Description: Contains online customer orders until the order is submitted or cancelled.<br/>
	/// </summary>
	[Serializable]
	public abstract partial class ShoppingCartItemEntityBase : CommonEntityBase, ISerializable
			...
			
	{
		...
		static ShoppingCartItemEntityBase()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ShoppingCartItemEntityBase()
		{
			InitClassEmpty(null);
		}
		...
		public ShoppingCartItemEntityBase(System.Int32 shoppingCartItemID)
		{
			InitClassFetch(shoppingCartItemID, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="shoppingCartItemID">PK value for ShoppingCartItem which data should be fetched into this ShoppingCartItem object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public ShoppingCartItemEntityBase(System.Int32 shoppingCartItemID, IPrefetchPath prefetchPathToUse)
		{
			InitClassFetch(shoppingCartItemID, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="shoppingCartItemID">PK value for ShoppingCartItem which data should be fetched into this ShoppingCartItem object</param>
		/// <param name="validator">The custom validator object for this ShoppingCartItemEntity</param>
		public ShoppingCartItemEntityBase(System.Int32 shoppingCartItemID, IValidator validator)
		{
			InitClassFetch(shoppingCartItemID, validator, null);
		}
		...
		protected ShoppingCartItemEntityBase(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return ShoppingCartItemEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Product":
					toReturn.Add(ShoppingCartItemEntity.Relations.ProductEntityUsingProductID);
					break;
		...
		{
			return FetchUsingPK(shoppingCartItemID, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 shoppingCartItemID, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(shoppingCartItemID, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 shoppingCartItemID, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return Fetch(shoppingCartItemID, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 shoppingCartItemID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(shoppingCartItemID, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.ShoppingCartItemID, null, null, null);
		}
		...
		public bool TestCurrentFieldValueForNull(ShoppingCartItemFieldIndex fieldIndex)
		{
		...
		public virtual ProductEntity GetSingleProduct(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(ShoppingCartItemEntity.Relations.ProductEntityUsingProductID);
		...
		{
			ShoppingCartItemDAO dao = (ShoppingCartItemDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ShoppingCartItemEntity);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 shoppingCartItemID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(shoppingCartItemID, prefetchPathToUse, null, null);
		...
		{
			base.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ShoppingCartItemEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "ShoppingCartItem", resetFKFields, new int[] { (int)ShoppingCartItemFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ShoppingCartItemEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 shoppingCartItemID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				IDao dao = this.CreateDAOInstance();
				base.Fields[(int)ShoppingCartItemFieldIndex.ShoppingCartItemID].ForcedCurrentValueWrite(shoppingCartItemID);
		...
		{
			return DAOFactory.CreateShoppingCartItemDAO();
		}
		...
		public static IPrefetchPathElement PrefetchPathProduct
		{
			get
			{
				return new PrefetchPathElement(new AW.Data.CollectionClasses.ProductCollection(),
					(IEntityRelation)GetRelationsForField("Product")[0], (int)AW.Data.EntityType.ShoppingCartItemEntity, (int)AW.Data.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return "ShoppingCartItemEntity";}
		}
		...
		{
			get { return ShoppingCartItemEntity.CustomProperties;}
		}
		...
		{
			get { return ShoppingCartItemEntity.FieldsCustomProperties;}
		}
		...
		public virtual System.Int32 ShoppingCartItemID
		{
			...
			set	{ SetValue((int)ShoppingCartItemFieldIndex.ShoppingCartItemID, value, true); }
		}
		...
		{ 
			get { return (int)AW.Data.EntityType.ShoppingCartItemEntity; }
		}
		#endregion
