...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TransactionHistoryArchive'. <br/>
	/// This class is used for Business Logic or for framework extension code. 
	/// </summary>
	[Serializable]
	public partial class TransactionHistoryArchiveEntity : TransactionHistoryArchiveEntityBase
