		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncStateProvince(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _stateProvince, new PropertyChangedEventHandler( OnStateProvincePropertyChanged ), "StateProvince", SalesTaxRateEntity.Relations.StateProvinceEntityUsingStateProvinceID, true, ref _alreadyFetchedStateProvince, new string[] {  } );
			}
		}
