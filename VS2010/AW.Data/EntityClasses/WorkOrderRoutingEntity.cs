...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void AddInternalsToContext()
		{
			if(_location!=null)
			{
				_location.ActiveContext = this.ActiveContext;
			}
			if(_workOrder!=null)
			{
				_workOrder.ActiveContext = this.ActiveContext;
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", WorkOrderRoutingEntity.Relations.LocationEntityUsingLocationID, true, signalRelatedEntity, "WorkOrderRoutings", resetFKFields, new int[] { (int)WorkOrderRoutingFieldIndex.LocationID } );		
			_location = null;
		}
		...
		private void SetupSyncLocation(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", WorkOrderRoutingEntity.Relations.LocationEntityUsingLocationID, true, ref _alreadyFetchedLocation, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _workOrder, new PropertyChangedEventHandler( OnWorkOrderPropertyChanged ), "WorkOrder", WorkOrderRoutingEntity.Relations.WorkOrderEntityUsingWorkOrderID, true, signalRelatedEntity, "WorkOrderRoutings", resetFKFields, new int[] { (int)WorkOrderRoutingFieldIndex.WorkOrderID } );		
			_workOrder = null;
		}
		...
		private void SetupSyncWorkOrder(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _workOrder, new PropertyChangedEventHandler( OnWorkOrderPropertyChanged ), "WorkOrder", WorkOrderRoutingEntity.Relations.WorkOrderEntityUsingWorkOrderID, true, ref _alreadyFetchedWorkOrder, new string[] {  } );
			}
		}
