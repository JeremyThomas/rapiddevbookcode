...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void AddInternalsToContext()
		{
			...
			_contacts.ActiveContext = this.ActiveContext;
			if(_salesPerson!=null)
			{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", StoreEntity.Relations.SalesPersonEntityUsingSalesPersonID, true, signalRelatedEntity, "Stores", resetFKFields, new int[] { (int)StoreFieldIndex.SalesPersonID } );		
			_salesPerson = null;
		}
		...
		private void SetupSyncSalesPerson(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", StoreEntity.Relations.SalesPersonEntityUsingSalesPersonID, true, ref _alreadyFetchedSalesPerson, new string[] {  } );
			}
		}
