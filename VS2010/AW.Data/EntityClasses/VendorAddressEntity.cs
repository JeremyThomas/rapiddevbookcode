...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public VendorAddressEntity(System.Int32 addressID, System.Int32 vendorID)
		{
		...
		public VendorAddressEntity(System.Int32 addressID, System.Int32 vendorID, IPrefetchPath prefetchPathToUse)
		{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", VendorAddressEntity.Relations.AddressEntityUsingAddressID, true, signalRelatedEntity, "VendorAddresses", resetFKFields, new int[] { (int)VendorAddressFieldIndex.AddressID } );		
			_address = null;
		}
		...
		private void SetupSyncAddress(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", VendorAddressEntity.Relations.AddressEntityUsingAddressID, true, ref _alreadyFetchedAddress, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _addressType, new PropertyChangedEventHandler( OnAddressTypePropertyChanged ), "AddressType", VendorAddressEntity.Relations.AddressTypeEntityUsingAddressTypeID, true, signalRelatedEntity, "VendorAddresses", resetFKFields, new int[] { (int)VendorAddressFieldIndex.AddressTypeID } );		
			_addressType = null;
		}
		...
		private void SetupSyncAddressType(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _addressType, new PropertyChangedEventHandler( OnAddressTypePropertyChanged ), "AddressType", VendorAddressEntity.Relations.AddressTypeEntityUsingAddressTypeID, true, ref _alreadyFetchedAddressType, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", VendorAddressEntity.Relations.VendorEntityUsingVendorID, true, signalRelatedEntity, "VendorAddresses", resetFKFields, new int[] { (int)VendorAddressFieldIndex.VendorID } );		
			_vendor = null;
		}
		...
		private void SetupSyncVendor(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", VendorAddressEntity.Relations.VendorEntityUsingVendorID, true, ref _alreadyFetchedVendor, new string[] {  } );
			}
		}
