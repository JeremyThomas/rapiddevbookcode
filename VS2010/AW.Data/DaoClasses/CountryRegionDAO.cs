...
namespace AW.Data.DaoClasses
{
	...
	public partial class CountryRegionDAO : CommonDaoBase
	{
		...
		/// <summary>Retrieves in the calling CountryRegionCollection object all CountryRegionEntity objects which are related via a relation of type 'm:n' with the passed in SalesTerritoryEntity.</summary>
		...
		public bool GetMultiUsingSalesTerritoryCollectionViaStateProvince(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity salesTerritoryInstance, IPrefetchPath prefetchPathToUse, int pageNumber, int pageSize)
		{
