...
namespace AW.Data.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class CustomerAddressEntityBase : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected CustomerAddressEntityBase() : base()
		{
			InitClassEmpty(null);
		}
		...
		protected CustomerAddressEntityBase(System.Int32 addressID, System.Int32 customerID)
		{
		...
		protected CustomerAddressEntityBase(System.Int32 addressID, System.Int32 customerID, IPrefetchPath prefetchPathToUse)
		{
		...
		protected CustomerAddressEntityBase(System.Int32 addressID, System.Int32 customerID, IValidator validator)
		{
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_addressType!=null)
			{
				_addressType.ActiveContext = this.ActiveContext;
			}
			if(_customer!=null)
			{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", CustomerAddressEntity.Relations.AddressEntityUsingAddressID, true, signalRelatedEntity, "CustomerAddresses", resetFKFields, new int[] { (int)CustomerAddressFieldIndex.AddressID } );		
			_address = null;
		}
		...
		private void SetupSyncAddress(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", CustomerAddressEntity.Relations.AddressEntityUsingAddressID, true, ref _alreadyFetchedAddress, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _addressType, new PropertyChangedEventHandler( OnAddressTypePropertyChanged ), "AddressType", CustomerAddressEntity.Relations.AddressTypeEntityUsingAddressTypeID, true, signalRelatedEntity, "CustomerAddresses", resetFKFields, new int[] { (int)CustomerAddressFieldIndex.AddressTypeID } );		
			_addressType = null;
		}
		...
		private void SetupSyncAddressType(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _addressType, new PropertyChangedEventHandler( OnAddressTypePropertyChanged ), "AddressType", CustomerAddressEntity.Relations.AddressTypeEntityUsingAddressTypeID, true, ref _alreadyFetchedAddressType, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", CustomerAddressEntity.Relations.CustomerEntityUsingCustomerID, true, signalRelatedEntity, "CustomerAddresses", resetFKFields, new int[] { (int)CustomerAddressFieldIndex.CustomerID } );		
			_customer = null;
		}
		...
		private void SetupSyncCustomer(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", CustomerAddressEntity.Relations.CustomerEntityUsingCustomerID, true, ref _alreadyFetchedCustomer, new string[] {  } );
			}
		}
