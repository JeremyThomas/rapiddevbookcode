...
namespace Northwind.DAL.EntityClasses
{
			...
			
	{
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_customerDemographic!=null)
			{
				_customerDemographic.ActiveContext = this.ActiveContext;
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", Relations.CustomerEntityUsingCustomerId, true, signalRelatedEntity, "CustomerCustomerDemos", resetFKFields, new int[] { (int)CustomerCustomerDemoFieldIndex.CustomerId } );
			_customer = null;
		}
		...
		private void SetupSyncCustomerDemographic(IEntity2 relatedEntity)
		{
			if(_customerDemographic!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customerDemographic, new PropertyChangedEventHandler( OnCustomerDemographicPropertyChanged ), "CustomerDemographic", Relations.CustomerDemographicEntityUsingCustomerTypeId, true, new string[] {  } );
			}
		}
