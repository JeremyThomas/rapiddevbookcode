...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListCountryRegionInstances.ascx.cs" Inherits="Controls_ListCountryRegionInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="CountryRegionCode" 
					DataSourceID="_CountryRegionDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
