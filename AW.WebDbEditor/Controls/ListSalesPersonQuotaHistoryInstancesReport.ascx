...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSalesPersonQuotaHistoryInstancesReport.ascx.cs" Inherits="Controls_ListSalesPersonQuotaHistoryInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\SalesPersonQuotaHistoryReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_SalesPersonQuotaHistoryDS" Name="SalesPersonQuotaHistory" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
