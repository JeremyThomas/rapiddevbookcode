<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchProductPhoto.ascx.cs" Inherits="Controls_SearchProductPhoto" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxProductPhotoID" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valProductPhotoID" runat="server" ControlToValidate="tbxProductPhotoID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqProductPhotoID" runat="server" ControlToValidate="tbxProductPhotoID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableLargePhotoFileName" runat="server" /></td>
		<td class="formtexts tableborder">
			LargePhotoFileName:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotLargePhotoFileName" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opLargePhotoFileName" runat="server">
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxLargePhotoFileNameMiFrom" runat="server" maxlength="50" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableProductPhotoID" runat="server" /></td>
		<td class="formtexts tableborder">
			ProductPhotoID:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotProductPhotoID" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opProductPhotoID" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="1" Text="Greater"/>
				<asp:ListItem Value="2" Text="Greater / Equal"/>
				<asp:ListItem Value="3" Text="Lesser"/>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxProductPhotoIDMiFrom" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiProductPhotoIDMiFrom" runat="server" ControlToValidate="tbxProductPhotoIDMiFrom" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
			and
			<asp:textbox id="tbxProductPhotoIDMiTo" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiProductPhotoIDMiTo" runat="server" ControlToValidate="tbxProductPhotoIDMiTo" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
		</td>
	</tr>
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableThumbnailPhotoFileName" runat="server" /></td>
		<td class="formtexts tableborder">
			ThumbnailPhotoFileName:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotThumbnailPhotoFileName" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opThumbnailPhotoFileName" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="6" Text="Null"/>
				<asp:ListItem Value="7" Text="Like"/>
			</asp:DropDownList>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxThumbnailPhotoFileNameMiFrom" runat="server" maxlength="50" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
		<td colspan="2" nowrap="nowrap" class="content">&nbsp;</td>
