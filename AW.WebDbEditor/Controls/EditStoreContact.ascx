...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditStoreContact.ascx.cs" Inherits="Controls_EditStoreContact" %>
<llblgenpro:LLBLGenProDataSource ID="_StoreContactDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.StoreContactCollection, AW.Data" LivePersistence="False" OnPerformSelect="_StoreContactDS_PerformSelect" OnPerformWork="_StoreContactDS_PerformWork"/>
<asp:FormView ID="frmEditStoreContact" DataKeyNames="ContactID, CustomerID" runat="server" DefaultMode="insert" DataSourceID="_StoreContactDS" Cellpadding="0" OnItemCommand="frmEditStoreContact_ItemCommand" OnItemCreated="frmEditStoreContact_ItemCreated">
<InsertItemTemplate>
...
<ItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			...
			<td class="content" width="100%">
			<asp:HyperLink ID="lnkCustomerID" runat="server" NavigateUrl='<%# "~/ViewExisting.aspx?EntityType=" + ((int)EntityType.StoreEntity).ToString() + "&CustomerID=" + Eval("CustomerID")%>' Text='<%# Bind("CustomerID") %>'/></td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
		<tr>
			<td width="20"  nowrap="nowrap" class="content">&nbsp;</td>
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this StoreContact instance with PK values: "  + "ContactID: " + Eval("ContactID") + "CustomerID: " + Eval("CustomerID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
