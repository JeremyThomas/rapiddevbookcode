...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListWorkOrderHistoryInstances.ascx.cs" Inherits="Controls_ListWorkOrderHistoryInstances" %>
...
<llblgenpro:LLBLGenProDataSource ID="_WorkOrderHistoryDS" runat="server" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.WorkOrderHistoryCollection, AW.Data" CacheLocation="Session" EnablePaging="True" />
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="TransactionID" 
					DataSourceID="_WorkOrderHistoryDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
