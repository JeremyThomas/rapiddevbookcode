...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListContactInstancesReport.ascx.cs" Inherits="Controls_ListContactInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\ContactReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_ContactDS" Name="Contact" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
