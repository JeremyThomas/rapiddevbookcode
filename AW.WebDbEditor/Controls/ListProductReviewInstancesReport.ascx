...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListProductReviewInstancesReport.ascx.cs" Inherits="Controls_ListProductReviewInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\ProductReviewReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_ProductReviewDS" Name="ProductReview" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
