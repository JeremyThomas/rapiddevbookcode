...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListJobCandidateInstances.ascx.cs" Inherits="Controls_ListJobCandidateInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="JobCandidateID" 
					DataSourceID="_JobCandidateDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
		...
		<asp:TemplateField HeaderText="JobCandidateID" SortExpression="JobCandidateID" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" ItemStyle-CssClass="ColumnContent" ItemStyle-Wrap="false" >
			<ItemTemplate>
				<asp:Label ID="lblJobCandidateID" runat="server" Text='<%# Bind("JobCandidateID") %>'/>
			</ItemTemplate>
		</asp:TemplateField>
