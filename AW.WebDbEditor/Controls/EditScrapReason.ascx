...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditScrapReason.ascx.cs" Inherits="Controls_EditScrapReason" %>
<llblgenpro:LLBLGenProDataSource ID="_ScrapReasonDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.ScrapReasonCollection, AW.Data" LivePersistence="False" OnPerformSelect="_ScrapReasonDS_PerformSelect" OnPerformWork="_ScrapReasonDS_PerformWork"/>
<asp:FormView ID="frmEditScrapReason" DataKeyNames="ScrapReasonID" runat="server" DefaultMode="insert" DataSourceID="_ScrapReasonDS" Cellpadding="0" OnItemCommand="frmEditScrapReason_ItemCommand" OnItemCreated="frmEditScrapReason_ItemCreated">
<InsertItemTemplate>
...
<EditItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:Label ID="lblScrapReasonID" runat="server" Text='<%# Bind("ScrapReasonID") %>'/>			</td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
		<tr>
			<td colspan="3" class="content">
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this ScrapReason instance with PK values: "  + "ScrapReasonID: " + Eval("ScrapReasonID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
