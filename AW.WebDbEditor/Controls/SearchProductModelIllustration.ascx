<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchProductModelIllustration.ascx.cs" Inherits="Controls_SearchProductModelIllustration" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxIllustrationID" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valIllustrationID" runat="server" ControlToValidate="tbxIllustrationID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqIllustrationID" runat="server" ControlToValidate="tbxIllustrationID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableIllustrationID" runat="server" /></td>
		<td class="formtexts tableborder">
			IllustrationID:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotIllustrationID" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opIllustrationID" runat="server">
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxIllustrationIDMiFrom" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiIllustrationIDMiFrom" runat="server" ControlToValidate="tbxIllustrationIDMiFrom" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
			and
			<asp:textbox id="tbxIllustrationIDMiTo" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiIllustrationIDMiTo" runat="server" ControlToValidate="tbxIllustrationIDMiTo" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
		</td>
	</tr>
	<tr>
