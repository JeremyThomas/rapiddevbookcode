...
public partial class Controls_ListProductCostHistoryInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.ProductCostHistoryEntity + additionalFiltersAsString);
	}
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
		...
		// export to excel
        GridViewExportUtils.Export("ProductCostHistory.xls", theGrid);
    }
	...
	protected void theGrid_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		...
		ProductCostHistoryEntity selectedEntity = (ProductCostHistoryEntity)_ProductCostHistoryDS.EntityCollection[index];
		...
		{
			case "EditExisting":
				Response.Redirect("~/EditExisting.aspx?EntityType=" + (int)EntityType.ProductCostHistoryEntity + pkFieldsAndValues.ToString());
				break;
			case "ViewExisting":
				Response.Redirect("~/ViewExisting.aspx?EntityType=" + (int)EntityType.ProductCostHistoryEntity + pkFieldsAndValues.ToString());
				break;
		}
	}
...
IPredicateExpression dsFilter;
			...
			case "ProductEntity":
				switch(name)
				{
					case "ProductCostHistories":
						...
						dsFilter.AddWithAnd(ProductCostHistoryFields.ProductID == ((ProductEntity)containingEntity).ProductID);
						_ProductCostHistoryDS.FilterToUse = dsFilter;
	...
	{
		set { _ProductCostHistoryDS.FilterToUse = value; }
	}
