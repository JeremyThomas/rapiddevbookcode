...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditSalesReason.ascx.cs" Inherits="Controls_EditSalesReason" %>
<llblgenpro:LLBLGenProDataSource ID="_SalesReasonDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.SalesReasonCollection, AW.Data" LivePersistence="False" OnPerformSelect="_SalesReasonDS_PerformSelect" OnPerformWork="_SalesReasonDS_PerformWork"/>
<asp:FormView ID="frmEditSalesReason" DataKeyNames="SalesReasonID" runat="server" DefaultMode="insert" DataSourceID="_SalesReasonDS" Cellpadding="0" OnItemCommand="frmEditSalesReason_ItemCommand" OnItemCreated="frmEditSalesReason_ItemCreated">
<InsertItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:textbox TextMode="MultiLine" Columns="50" Rows="2" id="tbxReasonType" runat="server" maxlength="50" Text='<%# Bind("ReasonType") %>' ValidationGroup="InsertValidations"  CssClass="required"/> *  <asp:RequiredFieldValidator ValidationGroup="InsertValidations" ID="reqReasonType" runat="server" ControlToValidate="tbxReasonType" Display="Dynamic" ErrorMessage="Required" />
...
<EditItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:textbox TextMode="MultiLine" Columns="50" Rows="2" id="tbxReasonType" runat="server" maxlength="50" Text='<%# Bind("ReasonType") %>' ValidationGroup="EditValidations"  CssClass="required"/> *  <asp:RequiredFieldValidator ValidationGroup="EditValidations" ID="reqReasonType" runat="server" ControlToValidate="tbxReasonType" Display="Dynamic" ErrorMessage="Required" />
...
<ItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			...
			<td class="content" width="100%">
			<asp:Label ID="lblReasonType" runat="server" Text='<%# Bind("ReasonType") %>'/></td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
		<tr>
			<td width="20"  nowrap="nowrap" class="content">&nbsp;</td>
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this SalesReason instance with PK values: "  + "SalesReasonID: " + Eval("SalesReasonID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
