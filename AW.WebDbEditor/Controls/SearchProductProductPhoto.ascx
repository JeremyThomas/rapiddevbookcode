<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchProductProductPhoto.ascx.cs" Inherits="Controls_SearchProductProductPhoto" %>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnablePrimary" runat="server" /></td>
		<td class="formtexts tableborder">
			Primary:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotPrimary" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opPrimary" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
			</asp:DropDownList>
		</td>
		
		<td class="content" tableborder" nowrap="nowrap">
			<asp:checkbox id="chkPrimaryMiFrom" runat="server" Checked=""/>
		</td>
	</tr>
	<tr>
