<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchDepartment.ascx.cs" Inherits="Controls_SearchDepartment" %>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableGroupName" runat="server" /></td>
		<td class="formtexts tableborder">
			GroupName:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotGroupName" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opGroupName" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxGroupNameMiFrom" runat="server" maxlength="50" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
