...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListScrapReasonInstances.ascx.cs" Inherits="Controls_ListScrapReasonInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="ScrapReasonID" 
					DataSourceID="_ScrapReasonDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
		...
		<asp:TemplateField HeaderText="ScrapReasonID" SortExpression="ScrapReasonID" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" ItemStyle-CssClass="ColumnContent" ItemStyle-Wrap="false" >
			<ItemTemplate>
				<asp:Label ID="lblScrapReasonID" runat="server" Text='<%# Bind("ScrapReasonID") %>'/>
			</ItemTemplate>
		</asp:TemplateField>
