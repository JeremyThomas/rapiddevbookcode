...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListContactCreditCardInstances.ascx.cs" Inherits="Controls_ListContactCreditCardInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="ContactID, CreditCardID" 
					DataSourceID="_ContactCreditCardDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
