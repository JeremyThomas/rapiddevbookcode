...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditAddressType.ascx.cs" Inherits="Controls_EditAddressType" %>
<llblgenpro:LLBLGenProDataSource ID="_AddressTypeDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.AddressTypeCollection, AW.Data" LivePersistence="False" OnPerformSelect="_AddressTypeDS_PerformSelect" OnPerformWork="_AddressTypeDS_PerformWork"/>
<asp:FormView ID="frmEditAddressType" DataKeyNames="AddressTypeID" runat="server" DefaultMode="insert" DataSourceID="_AddressTypeDS" Cellpadding="0" OnItemCommand="frmEditAddressType_ItemCommand" OnItemCreated="frmEditAddressType_ItemCreated">
<InsertItemTemplate>
...
<EditItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:Label ID="lblAddressTypeID" runat="server" Text='<%# Bind("AddressTypeID") %>'/>			</td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this AddressType instance with PK values: "  + "AddressTypeID: " + Eval("AddressTypeID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
