...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListCustomerInstances.ascx.cs" Inherits="Controls_ListCustomerInstances" %>
...
<llblgenpro:LLBLGenProDataSource ID="_CustomerDS" runat="server" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.CustomerCollection, AW.Data" CacheLocation="Session" EnablePaging="True" />
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="CustomerID" 
					DataSourceID="_CustomerDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
