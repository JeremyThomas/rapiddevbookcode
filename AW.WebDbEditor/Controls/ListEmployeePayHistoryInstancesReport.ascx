...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListEmployeePayHistoryInstancesReport.ascx.cs" Inherits="Controls_ListEmployeePayHistoryInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\EmployeePayHistoryReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_EmployeePayHistoryDS" Name="EmployeePayHistory" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
