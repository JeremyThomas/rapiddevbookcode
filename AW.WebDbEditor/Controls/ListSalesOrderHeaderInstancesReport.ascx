...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSalesOrderHeaderInstancesReport.ascx.cs" Inherits="Controls_ListSalesOrderHeaderInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\SalesOrderHeaderReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_SalesOrderHeaderDS" Name="SalesOrderHeader" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
