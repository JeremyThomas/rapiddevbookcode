...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListShiftInstancesReport.ascx.cs" Inherits="Controls_ListShiftInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\ShiftReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_ShiftDS" Name="Shift" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
