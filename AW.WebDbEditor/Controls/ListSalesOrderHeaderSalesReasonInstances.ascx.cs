...
public partial class Controls_ListSalesOrderHeaderSalesReasonInstances : System.Web.UI.UserControl, IListControl
{
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
		...
		// export to excel
        GridViewExportUtils.Export("SalesOrderHeaderSalesReason.xls", theGrid);
    }
	...
	protected void theGrid_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		...
		SalesOrderHeaderSalesReasonEntity selectedEntity = (SalesOrderHeaderSalesReasonEntity)_SalesOrderHeaderSalesReasonDS.EntityCollection[index];
		...
		{
			case "EditExisting":
				Response.Redirect("~/EditExisting.aspx?EntityType=" + (int)EntityType.SalesOrderHeaderSalesReasonEntity + pkFieldsAndValues.ToString());
				break;
			case "ViewExisting":
				Response.Redirect("~/ViewExisting.aspx?EntityType=" + (int)EntityType.SalesOrderHeaderSalesReasonEntity + pkFieldsAndValues.ToString());
				break;
		}
	}
