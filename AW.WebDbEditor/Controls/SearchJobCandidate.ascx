<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchJobCandidate.ascx.cs" Inherits="Controls_SearchJobCandidate" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxJobCandidateID" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valJobCandidateID" runat="server" ControlToValidate="tbxJobCandidateID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqJobCandidateID" runat="server" ControlToValidate="tbxJobCandidateID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableJobCandidateID" runat="server" /></td>
		<td class="formtexts tableborder">
			JobCandidateID:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotJobCandidateID" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opJobCandidateID" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="1" Text="Greater"/>
				<asp:ListItem Value="2" Text="Greater / Equal"/>
				<asp:ListItem Value="3" Text="Lesser"/>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxJobCandidateIDMiFrom" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiJobCandidateIDMiFrom" runat="server" ControlToValidate="tbxJobCandidateIDMiFrom" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
			and
			<asp:textbox id="tbxJobCandidateIDMiTo" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiJobCandidateIDMiTo" runat="server" ControlToValidate="tbxJobCandidateIDMiTo" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableResume" runat="server" /></td>
		<td class="formtexts tableborder">
			Resume:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotResume" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opResume" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="6" Text="Null"/>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxResumeMiFrom" runat="server" maxlength="2147483647" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
		<td colspan="2" nowrap="nowrap" class="content">&nbsp;</td>
