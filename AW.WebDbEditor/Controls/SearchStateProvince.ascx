<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchStateProvince.ascx.cs" Inherits="Controls_SearchStateProvince" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxStateProvinceID" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valStateProvinceID" runat="server" ControlToValidate="tbxStateProvinceID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqStateProvinceID" runat="server" ControlToValidate="tbxStateProvinceID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableIsOnlyStateProvinceFlag" runat="server" /></td>
		<td class="formtexts tableborder">
			IsOnlyStateProvinceFlag:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotIsOnlyStateProvinceFlag" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opIsOnlyStateProvinceFlag" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
			</asp:DropDownList>
		</td>
		
		<td class="content" tableborder" nowrap="nowrap">
			<asp:checkbox id="chkIsOnlyStateProvinceFlagMiFrom" runat="server" Checked=""/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableStateProvinceCode" runat="server" /></td>
		<td class="formtexts tableborder">
			StateProvinceCode:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotStateProvinceCode" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opStateProvinceCode" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="7" Text="Like"/>
			</asp:DropDownList>
		</td>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxStateProvinceCodeMiFrom" runat="server" maxlength="3" size="3" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
