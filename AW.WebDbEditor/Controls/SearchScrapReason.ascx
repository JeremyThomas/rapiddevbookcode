<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchScrapReason.ascx.cs" Inherits="Controls_SearchScrapReason" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxScrapReasonID" runat="server" maxlength="6" size="6" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valScrapReasonID" runat="server" ControlToValidate="tbxScrapReasonID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-32768" MaximumValue="32767" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqScrapReasonID" runat="server" ControlToValidate="tbxScrapReasonID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
