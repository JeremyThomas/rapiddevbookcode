...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListProductCategoryInstances.ascx.cs" Inherits="Controls_ListProductCategoryInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="ProductCategoryID" 
					DataSourceID="_ProductCategoryDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
		...
		<asp:TemplateField HeaderText="ProductCategoryID" SortExpression="ProductCategoryID" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" ItemStyle-CssClass="ColumnContent" ItemStyle-Wrap="false" >
			<ItemTemplate>
				<asp:Label ID="lblProductCategoryID" runat="server" Text='<%# Bind("ProductCategoryID") %>'/>
			</ItemTemplate>
		</asp:TemplateField>
