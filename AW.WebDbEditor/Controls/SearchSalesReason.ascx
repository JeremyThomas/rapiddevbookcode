<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchSalesReason.ascx.cs" Inherits="Controls_SearchSalesReason" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxSalesReasonID" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valSalesReasonID" runat="server" ControlToValidate="tbxSalesReasonID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqSalesReasonID" runat="server" ControlToValidate="tbxSalesReasonID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableReasonType" runat="server" /></td>
		<td class="formtexts tableborder">
			ReasonType:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotReasonType" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opReasonType" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="7" Text="Like"/>
			</asp:DropDownList>
		</td>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxReasonTypeMiFrom" runat="server" maxlength="50" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableSalesReasonID" runat="server" /></td>
		<td class="formtexts tableborder">
			SalesReasonID:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotSalesReasonID" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opSalesReasonID" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="1" Text="Greater"/>
				<asp:ListItem Value="2" Text="Greater / Equal"/>
				<asp:ListItem Value="3" Text="Lesser"/>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxSalesReasonIDMiFrom" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiSalesReasonIDMiFrom" runat="server" ControlToValidate="tbxSalesReasonIDMiFrom" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
			and
			<asp:textbox id="tbxSalesReasonIDMiTo" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiSalesReasonIDMiTo" runat="server" ControlToValidate="tbxSalesReasonIDMiTo" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
		</td>
	</tr>
	<tr>
		<td colspan="2" nowrap="nowrap" class="content">&nbsp;</td>
