...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditProductListPriceHistory.ascx.cs" Inherits="Controls_EditProductListPriceHistory" %>
<llblgenpro:LLBLGenProDataSource ID="_ProductListPriceHistoryDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.ProductListPriceHistoryCollection, AW.Data" LivePersistence="False" OnPerformSelect="_ProductListPriceHistoryDS_PerformSelect" OnPerformWork="_ProductListPriceHistoryDS_PerformWork"/>
<asp:FormView ID="frmEditProductListPriceHistory" DataKeyNames="ProductID, StartDate" runat="server" DefaultMode="insert" DataSourceID="_ProductListPriceHistoryDS" Cellpadding="0" OnItemCommand="frmEditProductListPriceHistory_ItemCommand" OnItemCreated="frmEditProductListPriceHistory_ItemCreated">
<InsertItemTemplate>
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this ProductListPriceHistory instance with PK values: "  + "ProductID: " + Eval("ProductID") + "StartDate: " + Eval("StartDate") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
