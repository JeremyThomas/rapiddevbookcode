...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSalesPersonInstancesReport.ascx.cs" Inherits="Controls_ListSalesPersonInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\SalesPersonReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_SalesPersonDS" Name="SalesPerson" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
