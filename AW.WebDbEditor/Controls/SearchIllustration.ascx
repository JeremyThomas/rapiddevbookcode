<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchIllustration.ascx.cs" Inherits="Controls_SearchIllustration" %>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableDiagram" runat="server" /></td>
		<td class="formtexts tableborder">
			Diagram:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotDiagram" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opDiagram" runat="server">
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxDiagramMiFrom" runat="server" maxlength="2147483647" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
