...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListStoreContactInstancesReport.ascx.cs" Inherits="Controls_ListStoreContactInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\StoreContactReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_StoreContactDS" Name="StoreContact" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
