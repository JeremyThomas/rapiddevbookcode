...
public partial class Controls_ListStoreContactInstances : System.Web.UI.UserControl, IListControl
{
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
		...
		// export to excel
        GridViewExportUtils.Export("StoreContact.xls", theGrid);
    }
	...
	protected void theGrid_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		...
		StoreContactEntity selectedEntity = (StoreContactEntity)_StoreContactDS.EntityCollection[index];
		...
		{
			case "EditExisting":
				Response.Redirect("~/EditExisting.aspx?EntityType=" + (int)EntityType.StoreContactEntity + pkFieldsAndValues.ToString());
				break;
			case "ViewExisting":
				Response.Redirect("~/ViewExisting.aspx?EntityType=" + (int)EntityType.StoreContactEntity + pkFieldsAndValues.ToString());
				break;
		}
	}
