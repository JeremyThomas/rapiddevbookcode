...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSalesTerritoryInstancesReport.ascx.cs" Inherits="Controls_ListSalesTerritoryInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\SalesTerritoryReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_SalesTerritoryDS" Name="SalesTerritory" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
