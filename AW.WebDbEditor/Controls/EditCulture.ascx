...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditCulture.ascx.cs" Inherits="Controls_EditCulture" %>
<llblgenpro:LLBLGenProDataSource ID="_CultureDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.CultureCollection, AW.Data" LivePersistence="False" OnPerformSelect="_CultureDS_PerformSelect" OnPerformWork="_CultureDS_PerformWork"/>
<asp:FormView ID="frmEditCulture" DataKeyNames="CultureID" runat="server" DefaultMode="insert" DataSourceID="_CultureDS" Cellpadding="0" OnItemCommand="frmEditCulture_ItemCommand" OnItemCreated="frmEditCulture_ItemCreated">
<InsertItemTemplate>
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this Culture instance with PK values: "  + "CultureID: " + Eval("CultureID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
