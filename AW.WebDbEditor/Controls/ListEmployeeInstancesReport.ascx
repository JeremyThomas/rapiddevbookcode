...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListEmployeeInstancesReport.ascx.cs" Inherits="Controls_ListEmployeeInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\EmployeeReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_EmployeeDS" Name="Employee" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
