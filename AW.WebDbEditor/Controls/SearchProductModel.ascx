<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchProductModel.ascx.cs" Inherits="Controls_SearchProductModel" %>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableCatalogDescription" runat="server" /></td>
		<td class="formtexts tableborder">
			CatalogDescription:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotCatalogDescription" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opCatalogDescription" runat="server">
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxCatalogDescriptionMiFrom" runat="server" maxlength="2147483647" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableInstructions" runat="server" /></td>
		<td class="formtexts tableborder">
			Instructions:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotInstructions" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opInstructions" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="6" Text="Null"/>
				<asp:ListItem Value="7" Text="Like"/>
			</asp:DropDownList>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxInstructionsMiFrom" runat="server" maxlength="2147483647" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
