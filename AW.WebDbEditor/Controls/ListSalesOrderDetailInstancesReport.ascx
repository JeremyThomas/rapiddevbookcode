...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSalesOrderDetailInstancesReport.ascx.cs" Inherits="Controls_ListSalesOrderDetailInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\SalesOrderDetailReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_SalesOrderDetailDS" Name="SalesOrderDetail" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
