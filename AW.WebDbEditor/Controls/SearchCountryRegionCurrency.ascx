<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchCountryRegionCurrency.ascx.cs" Inherits="Controls_SearchCountryRegionCurrency" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxCountryRegionCode" runat="server" maxlength="3" size="3" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>   <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqCountryRegionCode" runat="server" ControlToValidate="tbxCountryRegionCode" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxCurrencyCode" runat="server" maxlength="3" size="3" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>   <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqCurrencyCode" runat="server" ControlToValidate="tbxCurrencyCode" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableCurrencyCode" runat="server" /></td>
		<td class="formtexts tableborder">
			CurrencyCode:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotCurrencyCode" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opCurrencyCode" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="7" Text="Like"/>
			</asp:DropDownList>
		</td>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxCurrencyCodeMiFrom" runat="server" maxlength="3" size="3" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
