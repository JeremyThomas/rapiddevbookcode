...
namespace AW.Data.FactoryClasses
{
	...
	public class ElementCreator : ElementCreatorBase, IElementCreator
	{
		...
		{
			return new DynamicRelation(leftOperand, joinType, (AW.Data.EntityType)Enum.Parse(typeof(AW.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
