...
namespace AW.Data.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		{
			get { return Create<AwbuildVersionEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the DatabaseLog entity</summary>
		public EntityQuery<DatabaseLogEntity> DatabaseLog
		{
			get { return Create<DatabaseLogEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the ErrorLog entity</summary>
		public EntityQuery<ErrorLogEntity> ErrorLog
		{
			get { return Create<ErrorLogEntity>(); }
		}
		...
		public EntityQuery<PurchaseOrderHistoryEntity> PurchaseOrderHistory
		{
			get { return Create<PurchaseOrderHistoryEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the SalesOrderHistory entity</summary>
		public EntityQuery<SalesOrderHistoryEntity> SalesOrderHistory
		{
			get { return Create<SalesOrderHistoryEntity>(); }
		}
		...
		public EntityQuery<WorkOrderHistoryEntity> WorkOrderHistory
		{
			get { return Create<WorkOrderHistoryEntity>(); }
		}
		...
		public EntityQuery<CustomerViewRelatedEntity> CustomerViewRelated
		{
			get { return Create<CustomerViewRelatedEntity>(); }
		}
