...
namespace AW.Data.FactoryClasses
{
	...
	public partial class DAOFactory
	{
		...
		/// <summary>Creates a new EmployeeDepartmentHistoryDAO object</summary>
		...
		{
			return new EmployeeDepartmentHistoryDAO();
		}

		/// <summary>Creates a new EmployeePayHistoryDAO object</summary>
		...
		/// <summary>Creates a new ProductCostHistoryDAO object</summary>
		...
		{
			return new ProductCostHistoryDAO();
		}

		/// <summary>Creates a new ProductDescriptionDAO object</summary>
		...
		{
			return new ProductDescriptionDAO();
		}

		/// <summary>Creates a new ProductDocumentDAO object</summary>
		...
		{
			return new ProductDocumentDAO();
		}

		/// <summary>Creates a new ProductInventoryDAO object</summary>
		...
		/// <summary>Creates a new ProductListPriceHistoryDAO object</summary>
		...
		{
			return new ProductListPriceHistoryDAO();
		}

		/// <summary>Creates a new ProductModelDAO object</summary>
		...
		{
			return new ProductModelDAO();
		}

		/// <summary>Creates a new ProductModelIllustrationDAO object</summary>
		...
		{
			return new ProductModelIllustrationDAO();
		}

		/// <summary>Creates a new ProductModelProductDescriptionCultureDAO object</summary>
		...
		{
			return new ProductModelProductDescriptionCultureDAO();
		}
		...
		/// <summary>Creates a new ProductProductPhotoDAO object</summary>
		...
		{
			return new ProductProductPhotoDAO();
		}

		/// <summary>Creates a new ProductReviewDAO object</summary>
		...
		{
			return new ProductReviewDAO();
		}

		/// <summary>Creates a new ProductSubcategoryDAO object</summary>
		...
		{
			return new ProductVendorDAO();
		}

		/// <summary>Creates a new PurchaseOrderDetailDAO object</summary>
		...
		{
			return new PurchaseOrderDetailDAO();
		}

		/// <summary>Creates a new PurchaseOrderHeaderDAO object</summary>
		...
		/// <summary>Creates a new SalesOrderHeaderSalesReasonDAO object</summary>
		...
		{
			return new SalesOrderHeaderSalesReasonDAO();
		}

		/// <summary>Creates a new SalesPersonDAO object</summary>
		...
		{
			return new SalesPersonDAO();
		}

		/// <summary>Creates a new SalesPersonQuotaHistoryDAO object</summary>
		...
		{
			return new SalesPersonQuotaHistoryDAO();
		}

		/// <summary>Creates a new SalesReasonDAO object</summary>
		...
		{
			return new SalesReasonDAO();
		}

		/// <summary>Creates a new SalesTaxRateDAO object</summary>
		...
		{
			return new SalesTaxRateDAO();
		}

		/// <summary>Creates a new SalesTerritoryHistoryDAO object</summary>
		...
		{
			return new ShoppingCartItemDAO();
		}
		...
		/// <summary>Creates a new StoreContactDAO object</summary>
