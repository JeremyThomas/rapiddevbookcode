...
namespace AW.Data.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of StateProvinceEntity objects. </summary>
	[Serializable]
	public class StateProvinceCollection : EntityCollectionBase
	{
		/// <summary> CTor</summary>
		public StateProvinceCollection():base(new PropertyDescriptorFactory(), typeof(StateProvinceCollection), new StateProvinceEntityFactory(), null)
		{
		}
		...
		public StateProvinceCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):base(propertyDescriptorFactoryToUse, typeof(StateProvinceCollection), entityFactoryToUse, null)
		{
		}
		...
		public StateProvinceCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, StateProvinceValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeof(StateProvinceCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		///  <param name="validatorToUse">The validator object to use when creating entity objects during a GetMulti() call.</param>
		protected StateProvinceCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, Type typeOfDirectInheritor, IEntityFactory entityFactoryToUse, StateProvinceValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeOfDirectInheritor, entityFactoryToUse, validatorToUse)
		{
		}
		...
		protected StateProvinceCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		public virtual bool GetMultiManyToOne(IEntity countryRegionInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, countryRegionInstance, pageNumber, pageSize);
		}
		...
		/// <summary> Deletes from the persistent storage all StateProvince entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all StateProvince entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified StateProvinceEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
		...
		public object GetScalar(StateProvinceFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(StateProvinceFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(StateProvinceFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(StateProvinceFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(StateProvinceFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
