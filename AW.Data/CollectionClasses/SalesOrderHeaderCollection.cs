...
namespace AW.Data.CollectionClasses
{
	...
	[Serializable]
	public class SalesOrderHeaderCollection : EntityCollectionBase
	{
		/// <summary> CTor</summary>
		public SalesOrderHeaderCollection():base(new PropertyDescriptorFactory(), typeof(SalesOrderHeaderCollection), new SalesOrderHeaderEntityFactory(), null)
		{
		}
		...
		public SalesOrderHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):base(propertyDescriptorFactoryToUse, typeof(SalesOrderHeaderCollection), entityFactoryToUse, null)
		{
		}
		...
		public SalesOrderHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, SalesOrderHeaderValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeof(SalesOrderHeaderCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		///  <param name="validatorToUse">The validator object to use when creating entity objects during a GetMulti() call.</param>
		protected SalesOrderHeaderCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, Type typeOfDirectInheritor, IEntityFactory entityFactoryToUse, SalesOrderHeaderValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeOfDirectInheritor, entityFactoryToUse, validatorToUse)
		{
		}
		...
		/// <param name="customerView_Instance">CustomerViewRelatedEntity instance to use as a filter for the SalesOrderHeaderEntity objects to return</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity addressInstance, IEntity address_Instance, IEntity contactInstance, IEntity customerInstance, IEntity shipMethodInstance, IEntity customerView_Instance)
		{
			return GetMultiManyToOne(addressInstance, address_Instance, contactInstance, customerInstance, shipMethodInstance, customerView_Instance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity addressInstance, IEntity address_Instance, IEntity contactInstance, IEntity customerInstance, IEntity shipMethodInstance, IEntity customerView_Instance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(addressInstance, address_Instance, contactInstance, customerInstance, shipMethodInstance, customerView_Instance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity addressInstance, IEntity address_Instance, IEntity contactInstance, IEntity customerInstance, IEntity shipMethodInstance, IEntity customerView_Instance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(addressInstance, address_Instance, contactInstance, customerInstance, shipMethodInstance, customerView_Instance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity addressInstance, IEntity address_Instance, IEntity contactInstance, IEntity customerInstance, IEntity shipMethodInstance, IEntity customerView_Instance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			bool validParameters = false;
			validParameters |= (addressInstance!=null);
			validParameters |= (address_Instance!=null);
			validParameters |= (contactInstance!=null);
			validParameters |= (customerInstance!=null);
			validParameters |= (shipMethodInstance!=null);
			validParameters |= (customerView_Instance!=null);
			if(!validParameters)
			{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, filter, addressInstance, address_Instance, contactInstance, customerInstance, shipMethodInstance, customerView_Instance, pageNumber, pageSize);
		}
		...
		public int DeleteMultiManyToOne(IEntity addressInstance, IEntity address_Instance, IEntity contactInstance, IEntity customerInstance, IEntity shipMethodInstance, IEntity customerView_Instance)
		{
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
			return dao.DeleteMulti(base.Transaction, addressInstance, address_Instance, contactInstance, customerInstance, shipMethodInstance, customerView_Instance);
		}
		...
		/// <param name="customerView_Instance">CustomerViewRelatedEntity instance to use as a filter for the SalesOrderHeaderEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SalesOrderHeaderEntity entityWithNewValues, IEntity addressInstance, IEntity address_Instance, IEntity contactInstance, IEntity customerInstance, IEntity shipMethodInstance, IEntity customerView_Instance)
		{
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, addressInstance, address_Instance, contactInstance, customerInstance, shipMethodInstance, customerView_Instance);
		}
		...
		public virtual bool GetMultiManyToManyUsingSpecialOfferProductCollectionViaSalesOrderDetail(IEntity specialOfferProductInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
			return dao.GetMultiUsingSpecialOfferProductCollectionViaSalesOrderDetail(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, specialOfferProductInstance, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingSpecialOfferProductCollectionViaSalesOrderDetail(IEntity specialOfferProductInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			SalesOrderHeaderDAO dao = DAOFactory.CreateSalesOrderHeaderDAO();
			return dao.GetMultiUsingSpecialOfferProductCollectionViaSalesOrderDetail(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, specialOfferProductInstance, prefetchPathToUse);
		}
		...
		/// <summary> Deletes from the persistent storage all SalesOrderHeader entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all SalesOrderHeader entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified SalesOrderHeaderEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
