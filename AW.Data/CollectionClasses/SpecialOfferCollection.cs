...
namespace AW.Data.CollectionClasses
{
	...
	public partial class SpecialOfferCollection : EntityCollectionBase<SpecialOfferEntity>
	{
		...
		protected SpecialOfferCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		public virtual bool GetMultiManyToManyUsingProducts(IEntity productInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateSpecialOfferDAO().GetMultiUsingProducts(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, productInstance, null, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingProducts(IEntity productInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			return DAOFactory.CreateSpecialOfferDAO().GetMultiUsingProducts(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, productInstance, prefetchPathToUse, 0, 0);
		}
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(SpecialOfferFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
