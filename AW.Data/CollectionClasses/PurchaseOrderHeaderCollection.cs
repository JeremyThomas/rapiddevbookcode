...
namespace AW.Data.CollectionClasses
{
	...
	[Serializable]
	public partial class PurchaseOrderHeaderCollection : EntityCollectionBase<PurchaseOrderHeaderEntity>
	{
		/// <summary> CTor</summary>
		public PurchaseOrderHeaderCollection():base(new PurchaseOrderHeaderEntityFactory())
		{
		}
		...
		public PurchaseOrderHeaderCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected PurchaseOrderHeaderCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity employeeInstance, IEntity shipMethodInstance, IEntity vendorInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(employeeInstance, shipMethodInstance, vendorInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity employeeInstance, IEntity shipMethodInstance, IEntity vendorInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
		...
		/// <param name="entityWithNewValues">PurchaseOrderHeaderEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the PurchaseOrderHeaderEntity objects to return</param>
		/// <param name="shipMethodInstance">ShipMethodEntity instance to use as a filter for the PurchaseOrderHeaderEntity objects to return</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the PurchaseOrderHeaderEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		public object GetScalar(PurchaseOrderHeaderFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PurchaseOrderHeaderFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PurchaseOrderHeaderFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PurchaseOrderHeaderFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(PurchaseOrderHeaderFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
