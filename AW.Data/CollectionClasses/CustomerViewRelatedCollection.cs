...
namespace AW.Data.CollectionClasses
{
	...
	public partial class CustomerViewRelatedCollection : EntityCollectionBase<CustomerViewRelatedEntity>
	{
		...
		public CustomerViewRelatedCollection(IList<CustomerViewRelatedEntity> initialContents):base(new CustomerViewRelatedEntityFactory())
		{
		...
		/// <summary> Retrieves in this CustomerViewRelatedCollection object all CustomerViewRelatedEntity objects which are related via a  Relation of type 'm:n' with the passed in AddressEntity. 
		...
		/// <summary> Retrieves in this CustomerViewRelatedCollection object all CustomerViewRelatedEntity objects which are related via a  Relation of type 'm:n' with the passed in ContactEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this CustomerViewRelatedCollection object all CustomerViewRelatedEntity objects which are related via a  Relation of type 'm:n' with the passed in CreditCardEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this CustomerViewRelatedCollection object all CustomerViewRelatedEntity objects which are related via a  Relation of type 'm:n' with the passed in CurrencyRateEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this CustomerViewRelatedCollection object all CustomerViewRelatedEntity objects which are related via a  Relation of type 'm:n' with the passed in CustomerEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this CustomerViewRelatedCollection object all CustomerViewRelatedEntity objects which are related via a  Relation of type 'm:n' with the passed in SalesTerritoryEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this CustomerViewRelatedCollection object all CustomerViewRelatedEntity objects which are related via a  Relation of type 'm:n' with the passed in ShipMethodEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
