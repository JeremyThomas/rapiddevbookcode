...
namespace AW.Data.CollectionClasses
{
	...
	[Serializable]
	public partial class VendorContactCollection : EntityCollectionBase<VendorContactEntity>
	{
		/// <summary> CTor</summary>
		public VendorContactCollection():base(new VendorContactEntityFactory())
		{
		}
		...
		public VendorContactCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected VendorContactCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		/// <param name="entityWithNewValues">VendorContactEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		/// <param name="contactInstance">ContactEntity instance to use as a filter for the VendorContactEntity objects to return</param>
		/// <param name="contactTypeInstance">ContactTypeEntity instance to use as a filter for the VendorContactEntity objects to return</param>
		/// <param name="vendorInstance">VendorEntity instance to use as a filter for the VendorContactEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(VendorContactFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(VendorContactFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(VendorContactFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
