...
namespace AW.Data.CollectionClasses
{
	...
	public class ProductCollection : EntityCollectionBase
	{
		...
		public ProductCollection():base(new PropertyDescriptorFactory(), typeof(ProductCollection), new ProductEntityFactory(), null)
		{
		}
		...
		public ProductCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):base(propertyDescriptorFactoryToUse, typeof(ProductCollection), entityFactoryToUse, null)
		{
		}
		...
		public ProductCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, ProductValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeof(ProductCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		///  <param name="validatorToUse">The validator object to use when creating entity objects during a GetMulti() call.</param>
		protected ProductCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, Type typeOfDirectInheritor, IEntityFactory entityFactoryToUse, ProductValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeOfDirectInheritor, entityFactoryToUse, validatorToUse)
		{
		}
		...
		public virtual bool GetMultiManyToManyUsingSpecialOfferCollectionViaSpecialOfferProduct(IEntity specialOfferInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			return dao.GetMultiUsingSpecialOfferCollectionViaSpecialOfferProduct(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, specialOfferInstance, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingSpecialOfferCollectionViaSpecialOfferProduct(IEntity specialOfferInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			ProductDAO dao = DAOFactory.CreateProductDAO();
			return dao.GetMultiUsingSpecialOfferCollectionViaSpecialOfferProduct(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, specialOfferInstance, prefetchPathToUse);
		}
		...
		/// <summary> Deletes from the persistent storage all Product entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all Product entities from the persistent storage</param>
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified ProductEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
