...
namespace AW.Data.CollectionClasses
{
	...
	public partial class ProductCollection : EntityCollectionBase<ProductEntity>
	{
		...
		{
			return GetMultiManyToManyUsingSpecialOfferCollectionViaSpecialOfferProduct(specialOfferInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, 0, 0);
		}
		...
		{
			return GetMultiManyToManyUsingSpecialOfferCollectionViaSpecialOfferProduct(specialOfferInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, prefetchPathToUse);
		}
		...
		public virtual bool GetMultiManyToManyUsingSpecialOfferCollectionViaSpecialOfferProduct(IEntity specialOfferInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateProductDAO().GetMultiUsingSpecialOfferCollectionViaSpecialOfferProduct(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, specialOfferInstance, null, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingSpecialOfferCollectionViaSpecialOfferProduct(IEntity specialOfferInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			return DAOFactory.CreateProductDAO().GetMultiUsingSpecialOfferCollectionViaSpecialOfferProduct(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, specialOfferInstance, prefetchPathToUse, 0, 0);
		}
