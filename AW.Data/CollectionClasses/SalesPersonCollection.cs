...
namespace AW.Data.CollectionClasses
{
	...
	public partial class SalesPersonCollection : EntityCollectionBase<SalesPersonEntity>
	{
		...
		public SalesPersonCollection(IList<SalesPersonEntity> initialContents):base(new SalesPersonEntityFactory())
		{
		...
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity instance to use as a filter for the SalesPersonEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(SalesPersonEntity entityWithNewValues, IEntity salesTerritoryInstance)
		{
			SalesPersonDAO dao = DAOFactory.CreateSalesPersonDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, salesTerritoryInstance);
		}

		/// <summary> Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which are related via a  Relation of type 'm:n' with the passed in AddressEntity. 
		...
		/// <summary> Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which are related via a  Relation of type 'm:n' with the passed in ContactEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which are related via a  Relation of type 'm:n' with the passed in CreditCardEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which are related via a  Relation of type 'm:n' with the passed in CurrencyRateEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which are related via a  Relation of type 'm:n' with the passed in CustomerEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which are related via a  Relation of type 'm:n' with the passed in SalesTerritoryEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		/// <param name="salesTerritoryInstance">SalesTerritoryEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesTerritoryCollectionViaSalesTerritoryHistory(IEntity salesTerritoryInstance)
		{
			return GetMultiManyToManyUsingSalesTerritoryCollectionViaSalesTerritoryHistory(salesTerritoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesTerritoryCollectionViaSalesTerritoryHistory(IEntity salesTerritoryInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingSalesTerritoryCollectionViaSalesTerritoryHistory(salesTerritoryInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingSalesTerritoryCollectionViaSalesTerritoryHistory(IEntity salesTerritoryInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			SalesPersonDAO dao = DAOFactory.CreateSalesPersonDAO();
			return dao.GetMultiUsingSalesTerritoryCollectionViaSalesTerritoryHistory(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, salesTerritoryInstance, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesTerritoryCollectionViaSalesTerritoryHistory(IEntity salesTerritoryInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingSalesTerritoryCollectionViaSalesTerritoryHistory(salesTerritoryInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesTerritoryCollectionViaSalesTerritoryHistory(IEntity salesTerritoryInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			SalesPersonDAO dao = DAOFactory.CreateSalesPersonDAO();
			return dao.GetMultiUsingSalesTerritoryCollectionViaSalesTerritoryHistory(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, salesTerritoryInstance, prefetchPathToUse);
		}
		...
		/// <summary> Retrieves in this SalesPersonCollection object all SalesPersonEntity objects which are related via a  Relation of type 'm:n' with the passed in ShipMethodEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
