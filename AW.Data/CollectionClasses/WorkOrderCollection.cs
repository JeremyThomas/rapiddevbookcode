...
namespace AW.Data.CollectionClasses
{
	...
	public partial class WorkOrderCollection : EntityCollectionBase<WorkOrderEntity>
	{
		...
		public WorkOrderCollection(IList<WorkOrderEntity> initialContents):base(new WorkOrderEntityFactory())
		{
		...
		{
			return GetMultiManyToOne(productInstance, scrapReasonInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(productInstance, scrapReasonInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		public bool GetMultiManyToManyUsingLocationCollectionViaWorkOrderRouting(IEntity locationInstance)
		{
			return GetMultiManyToManyUsingLocationCollectionViaWorkOrderRouting(locationInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingLocationCollectionViaWorkOrderRouting(IEntity locationInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingLocationCollectionViaWorkOrderRouting(locationInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingLocationCollectionViaWorkOrderRouting(IEntity locationInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			WorkOrderDAO dao = DAOFactory.CreateWorkOrderDAO();
			return dao.GetMultiUsingLocationCollectionViaWorkOrderRouting(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, locationInstance, pageNumber, pageSize);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingLocationCollectionViaWorkOrderRouting(IEntity locationInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingLocationCollectionViaWorkOrderRouting(locationInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
