...
namespace AW.Data.CollectionClasses
{
	...
	public partial class SpecialOfferProductCollection : EntityCollectionBase<SpecialOfferProductEntity>
	{
		...
		public SpecialOfferProductCollection(IEnumerable<SpecialOfferProductEntity> initialContents):base(new SpecialOfferProductEntityFactory())
		{
		...
		{
			return GetMultiManyToOne(productInstance, specialOfferInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(productInstance, specialOfferInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, filter, 0, 0);
		}
		...
		public virtual bool GetMultiManyToOne(IEntity productInstance, IEntity specialOfferInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateSpecialOfferProductDAO().GetMulti(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, filter, productInstance, specialOfferInstance, pageNumber, pageSize);
		}
		...
		{
			return DAOFactory.CreateSpecialOfferProductDAO().DeleteMulti(this.Transaction, productInstance, specialOfferInstance);
		}
		...
		{
			return DAOFactory.CreateSpecialOfferProductDAO().UpdateMulti(entityWithNewValues, this.Transaction, productInstance, specialOfferInstance);
		}

		/// <summary> Retrieves in this SpecialOfferProductCollection object all SpecialOfferProductEntity objects which are related via a  Relation of type 'm:n' with the passed in SalesOrderHeaderEntity. All current elements in the collection are removed from the collection.</summary>
		...
		public bool GetMultiManyToManyUsingSalesOrders(IEntity salesOrderHeaderInstance)
		{
			return GetMultiManyToManyUsingSalesOrders(salesOrderHeaderInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesOrders(IEntity salesOrderHeaderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingSalesOrders(salesOrderHeaderInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesOrders(IEntity salesOrderHeaderInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingSalesOrders(salesOrderHeaderInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingSalesOrders(IEntity salesOrderHeaderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!this.SuppressClearInGetMulti)
			{
				this.Clear();
			}
			return DAOFactory.CreateSpecialOfferProductDAO().GetMultiUsingSalesOrders(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, salesOrderHeaderInstance, null, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingSalesOrders(IEntity salesOrderHeaderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!this.SuppressClearInGetMulti)
			{
				this.Clear();
			}
			return DAOFactory.CreateSpecialOfferProductDAO().GetMultiUsingSalesOrders(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, salesOrderHeaderInstance, prefetchPathToUse, 0, 0);
		}
		...
		public virtual object GetScalar(SpecialOfferProductFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
			...
			return DAOFactory.CreateSpecialOfferProductDAO().GetScalar(fields, this.Transaction, filter, relations, groupByClause);
		}
