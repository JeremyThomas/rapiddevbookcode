...
namespace AW.Data.CollectionClasses
{
	...
	public class AddressTypeCollection : EntityCollectionBase
	{
		...
		public AddressTypeCollection():base(new PropertyDescriptorFactory(), typeof(AddressTypeCollection), new AddressTypeEntityFactory(), null)
		{
		}
		...
		public AddressTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):base(propertyDescriptorFactoryToUse, typeof(AddressTypeCollection), entityFactoryToUse, null)
		{
		}
		...
		public AddressTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, AddressTypeValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeof(AddressTypeCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		///  <param name="validatorToUse">The validator object to use when creating entity objects during a GetMulti() call.</param>
		protected AddressTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, Type typeOfDirectInheritor, IEntityFactory entityFactoryToUse, AddressTypeValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeOfDirectInheritor, entityFactoryToUse, validatorToUse)
		{
		}
		...
		public virtual bool GetMultiManyToManyUsingAddressCollectionViaCustomerAddress(IEntity addressInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			return dao.GetMultiUsingAddressCollectionViaCustomerAddress(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, addressInstance, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingAddressCollectionViaCustomerAddress(IEntity addressInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			AddressTypeDAO dao = DAOFactory.CreateAddressTypeDAO();
			return dao.GetMultiUsingAddressCollectionViaCustomerAddress(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, addressInstance, prefetchPathToUse);
		}
		...
		public virtual bool GetMultiManyToManyUsingCustomerCollectionViaCustomerAddress(IEntity customerInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			AddressTypeDAO dao = DAOFactory.CreateAddressTypeDAO();
			return dao.GetMultiUsingCustomerCollectionViaCustomerAddress(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, customerInstance, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingCustomerCollectionViaCustomerAddress(IEntity customerInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			AddressTypeDAO dao = DAOFactory.CreateAddressTypeDAO();
			return dao.GetMultiUsingCustomerCollectionViaCustomerAddress(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, customerInstance, prefetchPathToUse);
		}
		...
		/// <summary> Deletes from the persistent storage all AddressType entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all AddressType entities from the persistent storage</param>
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified AddressTypeEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
		/// <i>changed</i> in entityWithNewValues. The new values of these fields are read from entityWithNewValues. </summary>
		/// <param name="entityWithNewValues">AddressTypeEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
