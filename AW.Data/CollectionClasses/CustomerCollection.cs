...
namespace AW.Data.CollectionClasses
{
	...
	public class CustomerCollection : EntityCollectionBase
	{
		...
		public CustomerCollection():base(new PropertyDescriptorFactory(), typeof(CustomerCollection), new CustomerEntityFactory(), null)
		{
		}
		...
		public CustomerCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):base(propertyDescriptorFactoryToUse, typeof(CustomerCollection), entityFactoryToUse, null)
		{
		}
		...
		public CustomerCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, CustomerValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeof(CustomerCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		///  <param name="validatorToUse">The validator object to use when creating entity objects during a GetMulti() call.</param>
		protected CustomerCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, Type typeOfDirectInheritor, IEntityFactory entityFactoryToUse, CustomerValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeOfDirectInheritor, entityFactoryToUse, validatorToUse)
		{
		}
		...
		public virtual bool GetMultiManyToManyUsingAddressTypeCollectionViaCustomerAddress(IEntity addressTypeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			CustomerDAO dao = DAOFactory.CreateCustomerDAO();
			return dao.GetMultiUsingAddressTypeCollectionViaCustomerAddress(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, addressTypeInstance, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingAddressTypeCollectionViaCustomerAddress(IEntity addressTypeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			CustomerDAO dao = DAOFactory.CreateCustomerDAO();
			return dao.GetMultiUsingAddressTypeCollectionViaCustomerAddress(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, base.ValidatorToUse, addressTypeInstance, prefetchPathToUse);
		}
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified CustomerEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
