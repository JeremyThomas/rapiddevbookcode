...
namespace AW.Data.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of ShiftEntity objects. </summary>
	[Serializable]
	public partial class ShiftCollection : EntityCollectionBase<ShiftEntity>
	{
		/// <summary> CTor</summary>
		public ShiftCollection():base(new ShiftEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public ShiftCollection(IList<ShiftEntity> initialContents):base(new ShiftEntityFactory())
		{
		...
		public ShiftCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected ShiftCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		public object GetScalar(ShiftFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(ShiftFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(ShiftFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(ShiftFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
