...
namespace AW.Data.CollectionClasses
{
	...
	[Serializable]
	public partial class EmployeeDepartmentHistoryCollection : EntityCollectionBase<EmployeeDepartmentHistoryEntity>
	{
		/// <summary> CTor</summary>
		public EmployeeDepartmentHistoryCollection():base(new EmployeeDepartmentHistoryEntityFactory())
		{
		}
		...
		public EmployeeDepartmentHistoryCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected EmployeeDepartmentHistoryCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity departmentInstance, IEntity employeeInstance, IEntity shiftInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(departmentInstance, employeeInstance, shiftInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity departmentInstance, IEntity employeeInstance, IEntity shiftInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			bool validParameters = false;
			validParameters |= (departmentInstance!=null);
			validParameters |= (employeeInstance!=null);
			validParameters |= (shiftInstance!=null);
			if(!validParameters)
			{
		...
		/// <param name="entityWithNewValues">EmployeeDepartmentHistoryEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		/// <param name="departmentInstance">DepartmentEntity instance to use as a filter for the EmployeeDepartmentHistoryEntity objects to return</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the EmployeeDepartmentHistoryEntity objects to return</param>
		/// <param name="shiftInstance">ShiftEntity instance to use as a filter for the EmployeeDepartmentHistoryEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		public object GetScalar(EmployeeDepartmentHistoryFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(EmployeeDepartmentHistoryFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(EmployeeDepartmentHistoryFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(EmployeeDepartmentHistoryFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(EmployeeDepartmentHistoryFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
