...
namespace AW.Data.EntityClasses
{
			...
			
	{
		...
		/// CTor
		/// </summary>
		public CustomerViewRelatedEntity():base(new PropertyDescriptorFactory(), new CustomerViewRelatedEntityFactory())
		{
		}
		...
		public CustomerViewRelatedEntity(System.Int32 customerId, CustomerViewRelatedValidator validator):
		...
		public CustomerViewRelatedEntity(System.Int32 customerId, CustomerViewRelatedValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public CustomerViewRelatedEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):
