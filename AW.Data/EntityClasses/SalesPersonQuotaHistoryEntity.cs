		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncSalesPerson(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", AW.Data.RelationClasses.StaticSalesPersonQuotaHistoryRelations.SalesPersonEntityUsingSalesPersonIDStatic, true, ref _alreadyFetchedSalesPerson, new string[] {  } );
			}
		}
