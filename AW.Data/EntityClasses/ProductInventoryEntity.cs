...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", ProductInventoryEntity.Relations.LocationEntityUsingLocationID, true, signalRelatedEntity, "ProductInventories", resetFKFields, new int[] { (int)ProductInventoryFieldIndex.LocationID } );		
			_location = null;
		}
		...
		private void SetupSyncLocation(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", ProductInventoryEntity.Relations.LocationEntityUsingLocationID, true, ref _alreadyFetchedLocation, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductInventoryEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "ProductInventories", resetFKFields, new int[] { (int)ProductInventoryFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductInventoryEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
