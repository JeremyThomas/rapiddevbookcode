...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'SpecialOffer'. <br/>
			...
			
	{
		...
		/// CTor
		/// </summary>
		public SpecialOfferEntity():base(new PropertyDescriptorFactory(), new SpecialOfferEntityFactory())
		{
		}
		...
		public SpecialOfferEntity(System.Int32 specialOfferId, SpecialOfferValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):
			base(specialOfferId, validator, propertyDescriptorFactoryToUse, entityFactoryToUse)
		{
		}
