...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", JobCandidateEntity.Relations.EmployeeEntityUsingEmployeeID, true, signalRelatedEntity, "JobCandidates", resetFKFields, new int[] { (int)JobCandidateFieldIndex.EmployeeID } );		
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", JobCandidateEntity.Relations.EmployeeEntityUsingEmployeeID, true, ref _alreadyFetchedEmployee, new string[] {  } );
			}
		}
