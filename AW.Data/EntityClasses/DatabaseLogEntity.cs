...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'DatabaseLog'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return FetchUsingPK(databaseLogID, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 databaseLogID, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(databaseLogID, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 databaseLogID, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(databaseLogID, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 databaseLogID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(databaseLogID, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.DatabaseLogID, null, null, null);
		}
		...
		{
			return new DatabaseLogRelations().GetAllRelations();
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int32 databaseLogID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(databaseLogID, prefetchPathToUse, null, null);
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 databaseLogID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)DatabaseLogFieldIndex.DatabaseLogID].ForcedCurrentValueWrite(databaseLogID);
		...
		{
			return DAOFactory.CreateDatabaseLogDAO();
		}
		...
		/// <summary> The DatabaseLogID property of the Entity DatabaseLog<br/><br/></summary>
		...
		public virtual System.Int32 DatabaseLogID
		{
			...
			set	{ SetValue((int)DatabaseLogFieldIndex.DatabaseLogID, value, true); }
		}

		/// <summary> The DatabaseUser property of the Entity DatabaseLog<br/><br/></summary>
		...
		public virtual System.String DatabaseUser
		{
			...
			set	{ SetValue((int)DatabaseLogFieldIndex.DatabaseUser, value, true); }
		}

		/// <summary> The Event property of the Entity DatabaseLog<br/><br/></summary>
		...
		public virtual System.String Event
		{
			...
			set	{ SetValue((int)DatabaseLogFieldIndex.Event, value, true); }
		}

		/// <summary> The Object property of the Entity DatabaseLog<br/><br/></summary>
		...
		public virtual System.String Object
		{
			...
			set	{ SetValue((int)DatabaseLogFieldIndex.Object, value, true); }
		}

		/// <summary> The PostTime property of the Entity DatabaseLog<br/><br/></summary>
		...
		public virtual System.DateTime PostTime
		{
			...
			set	{ SetValue((int)DatabaseLogFieldIndex.PostTime, value, true); }
		}

		/// <summary> The Schema property of the Entity DatabaseLog<br/><br/></summary>
		...
		public virtual System.String Schema
		{
			...
			set	{ SetValue((int)DatabaseLogFieldIndex.Schema, value, true); }
		}

		/// <summary> The Tsql property of the Entity DatabaseLog<br/><br/></summary>
		...
		public virtual System.String Tsql
		{
			...
			set	{ SetValue((int)DatabaseLogFieldIndex.Tsql, value, true); }
		}

		/// <summary> The XmlEvent property of the Entity DatabaseLog<br/><br/></summary>
		...
		public virtual System.String XmlEvent
		{
			...
			set	{ SetValue((int)DatabaseLogFieldIndex.XmlEvent, value, true); }
		}
		...
		{ 
			get { return (int)AW.Data.EntityType.DatabaseLogEntity; }
		}
