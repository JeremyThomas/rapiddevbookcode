...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'UnitMeasure'. <br/>
	/// This class is used for Business Logic or for framework extension code. 
	/// </summary>
	[Serializable]
	public partial class UnitMeasureEntity : UnitMeasureEntityBase
			...
			
	{
		...
		public UnitMeasureEntity(System.String unitMeasureCode, IPrefetchPath prefetchPathToUse):
			base(unitMeasureCode, prefetchPathToUse)
		{
		}
		...
		public UnitMeasureEntity(System.String unitMeasureCode, IValidator validator):
			base(unitMeasureCode, validator)
		{
		}
