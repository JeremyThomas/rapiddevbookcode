...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _contact, new PropertyChangedEventHandler( OnContactPropertyChanged ), "Contact", StoreContactEntity.Relations.ContactEntityUsingContactID, true, signalRelatedEntity, "StoreContacts", resetFKFields, new int[] { (int)StoreContactFieldIndex.ContactID } );		
			_contact = null;
		}
		...
		private void SetupSyncContact(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _contact, new PropertyChangedEventHandler( OnContactPropertyChanged ), "Contact", StoreContactEntity.Relations.ContactEntityUsingContactID, true, ref _alreadyFetchedContact, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _contactType, new PropertyChangedEventHandler( OnContactTypePropertyChanged ), "ContactType", StoreContactEntity.Relations.ContactTypeEntityUsingContactTypeID, true, signalRelatedEntity, "StoreContacts", resetFKFields, new int[] { (int)StoreContactFieldIndex.ContactTypeID } );		
			_contactType = null;
		}
		...
		private void SetupSyncContactType(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _contactType, new PropertyChangedEventHandler( OnContactTypePropertyChanged ), "ContactType", StoreContactEntity.Relations.ContactTypeEntityUsingContactTypeID, true, ref _alreadyFetchedContactType, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", StoreContactEntity.Relations.StoreEntityUsingCustomerID, true, signalRelatedEntity, "StoreContacts", resetFKFields, new int[] { (int)StoreContactFieldIndex.CustomerID } );		
			_store = null;
		}
		...
		private void SetupSyncStore(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", StoreContactEntity.Relations.StoreEntityUsingCustomerID, true, ref _alreadyFetchedStore, new string[] {  } );
			}
		}
