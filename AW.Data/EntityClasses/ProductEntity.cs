...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			_billOfAssemblyMaterials.ActiveContext = this.ActiveContext;
			_billOfComponentMaterials.ActiveContext = this.ActiveContext;
			...
			if(_sizeUnitMeasure!=null)
			{
				_sizeUnitMeasure.ActiveContext = this.ActiveContext;
			}
			if(_weightUnitMeasure!=null)
			{
				_weightUnitMeasure.ActiveContext = this.ActiveContext;
			}
		}
		...
		private void SetupSyncSizeUnitMeasure(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _sizeUnitMeasure, new PropertyChangedEventHandler( OnSizeUnitMeasurePropertyChanged ), "SizeUnitMeasure", ProductEntity.Relations.UnitMeasureEntityUsingSizeUnitMeasureCode, true, ref _alreadyFetchedSizeUnitMeasure, new string[] {  } );
			}
		}
		...
		private void SetupSyncWeightUnitMeasure(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _weightUnitMeasure, new PropertyChangedEventHandler( OnWeightUnitMeasurePropertyChanged ), "WeightUnitMeasure", ProductEntity.Relations.UnitMeasureEntityUsingWeightUnitMeasureCode, true, ref _alreadyFetchedWeightUnitMeasure, new string[] {  } );
			}
		}
