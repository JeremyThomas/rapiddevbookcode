...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductVendorEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "ProductVendors", resetFKFields, new int[] { (int)ProductVendorFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductVendorEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _unitMeasure, new PropertyChangedEventHandler( OnUnitMeasurePropertyChanged ), "UnitMeasure", ProductVendorEntity.Relations.UnitMeasureEntityUsingUnitMeasureCode, true, signalRelatedEntity, "ProductVendors", resetFKFields, new int[] { (int)ProductVendorFieldIndex.UnitMeasureCode } );		
			_unitMeasure = null;
		}
		...
		private void SetupSyncUnitMeasure(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _unitMeasure, new PropertyChangedEventHandler( OnUnitMeasurePropertyChanged ), "UnitMeasure", ProductVendorEntity.Relations.UnitMeasureEntityUsingUnitMeasureCode, true, ref _alreadyFetchedUnitMeasure, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", ProductVendorEntity.Relations.VendorEntityUsingVendorID, true, signalRelatedEntity, "ProductVendors", resetFKFields, new int[] { (int)ProductVendorFieldIndex.VendorID } );		
			_vendor = null;
		}
		...
		private void SetupSyncVendor(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", ProductVendorEntity.Relations.VendorEntityUsingVendorID, true, ref _alreadyFetchedVendor, new string[] {  } );
			}
		}
		...
		/// <summary> The MaxOrderQuantity property of the Entity ProductVendor<br/><br/></summary>
		...
		/// <summary> The MinOrderQuantity property of the Entity ProductVendor<br/><br/></summary>
		...
		/// <summary> The OnOrderQuantity property of the Entity ProductVendor<br/><br/></summary>
