		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncCountryRegion(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _countryRegion, new PropertyChangedEventHandler( OnCountryRegionPropertyChanged ), "CountryRegion", AW.Data.RelationClasses.StaticStateProvinceRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, ref _alreadyFetchedCountryRegion, new string[] {  } );
			}
		}
		...
		private void SetupSyncSalesTerritory(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", AW.Data.RelationClasses.StaticStateProvinceRelations.SalesTerritoryEntityUsingTerritoryIDStatic, true, ref _alreadyFetchedSalesTerritory, new string[] {  } );
			}
		}
