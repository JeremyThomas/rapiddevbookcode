...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public PurchaseOrderDetailEntity(System.Int32 purchaseOrderDetailID, System.Int32 purchaseOrderID)
		{
		...
		public PurchaseOrderDetailEntity(System.Int32 purchaseOrderDetailID, System.Int32 purchaseOrderID, IPrefetchPath prefetchPathToUse)
		{
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_purchaseOrderHeader!=null)
			{
				_purchaseOrderHeader.ActiveContext = this.ActiveContext;
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", PurchaseOrderDetailEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "PurchaseOrderDetails", resetFKFields, new int[] { (int)PurchaseOrderDetailFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", PurchaseOrderDetailEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private void SetupSyncPurchaseOrderHeader(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _purchaseOrderHeader, new PropertyChangedEventHandler( OnPurchaseOrderHeaderPropertyChanged ), "PurchaseOrderHeader", PurchaseOrderDetailEntity.Relations.PurchaseOrderHeaderEntityUsingPurchaseOrderID, true, ref _alreadyFetchedPurchaseOrderHeader, new string[] {  } );
			}
		}
