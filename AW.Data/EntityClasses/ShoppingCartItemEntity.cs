...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ShoppingCartItemEntity(System.Int32 shoppingCartItemID, IPrefetchPath prefetchPathToUse):base("ShoppingCartItemEntity")
		{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AW.Data.RelationClasses.StaticShoppingCartItemRelations.ProductEntityUsingProductIDStatic, true, signalRelatedEntity, "ShoppingCartItems", resetFKFields, new int[] { (int)ShoppingCartItemFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AW.Data.RelationClasses.StaticShoppingCartItemRelations.ProductEntityUsingProductIDStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
