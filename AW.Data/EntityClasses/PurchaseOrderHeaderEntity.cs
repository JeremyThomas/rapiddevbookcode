...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", PurchaseOrderHeaderEntity.Relations.EmployeeEntityUsingEmployeeID, true, signalRelatedEntity, "PurchaseOrderHeaders", resetFKFields, new int[] { (int)PurchaseOrderHeaderFieldIndex.EmployeeID } );		
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", PurchaseOrderHeaderEntity.Relations.EmployeeEntityUsingEmployeeID, true, ref _alreadyFetchedEmployee, new string[] {  } );
			}
		}
		...
		private void SetupSyncShipMethod(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _shipMethod, new PropertyChangedEventHandler( OnShipMethodPropertyChanged ), "ShipMethod", PurchaseOrderHeaderEntity.Relations.ShipMethodEntityUsingShipMethodID, true, ref _alreadyFetchedShipMethod, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", PurchaseOrderHeaderEntity.Relations.VendorEntityUsingVendorID, true, signalRelatedEntity, "PurchaseOrderHeaders", resetFKFields, new int[] { (int)PurchaseOrderHeaderFieldIndex.VendorID } );		
			_vendor = null;
		}
		...
		private void SetupSyncVendor(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", PurchaseOrderHeaderEntity.Relations.VendorEntityUsingVendorID, true, ref _alreadyFetchedVendor, new string[] {  } );
			}
		}
