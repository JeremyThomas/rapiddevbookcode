...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ProductDocumentEntity(System.Int32 documentID, System.Int32 productID)
		{
		...
		public ProductDocumentEntity(System.Int32 documentID, System.Int32 productID, IPrefetchPath prefetchPathToUse)
		{
		...
		protected override void AddInternalsToContext()
		{
			if(_document!=null)
			{
				_document.ActiveContext = this.ActiveContext;
			}
			if(_product!=null)
			{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _document, new PropertyChangedEventHandler( OnDocumentPropertyChanged ), "Document", ProductDocumentEntity.Relations.DocumentEntityUsingDocumentID, true, signalRelatedEntity, "ProductDocuments", resetFKFields, new int[] { (int)ProductDocumentFieldIndex.DocumentID } );		
			_document = null;
		}
		...
		private void SetupSyncDocument(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _document, new PropertyChangedEventHandler( OnDocumentPropertyChanged ), "Document", ProductDocumentEntity.Relations.DocumentEntityUsingDocumentID, true, ref _alreadyFetchedDocument, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductDocumentEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "ProductDocuments", resetFKFields, new int[] { (int)ProductDocumentFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductDocumentEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
