...
namespace AW.Data.EntityClasses
{
	...
	/// <summary>Entity base class which represents the base class for the entity 'ProductListPriceHistory'.<br/><br/>
	/// 
	/// MS_Description: Changes in the list price of a product over time.<br/>
	/// </summary>
	[Serializable]
	public abstract partial class ProductListPriceHistoryEntityBase : CommonEntityBase, ISerializable
			...
			
	{
		...
		static ProductListPriceHistoryEntityBase()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ProductListPriceHistoryEntityBase()
		{
			InitClassEmpty(null);
		}
		...
		public ProductListPriceHistoryEntityBase(System.Int32 productID, System.DateTime startDate)
		{
		...
		public ProductListPriceHistoryEntityBase(System.Int32 productID, System.DateTime startDate, IPrefetchPath prefetchPathToUse)
		{
		...
		public ProductListPriceHistoryEntityBase(System.Int32 productID, System.DateTime startDate, IValidator validator)
		{
		...
		protected ProductListPriceHistoryEntityBase(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return ProductListPriceHistoryEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Product":
					toReturn.Add(ProductListPriceHistoryEntity.Relations.ProductEntityUsingProductID);
					break;
		...
		public bool TestCurrentFieldValueForNull(ProductListPriceHistoryFieldIndex fieldIndex)
		{
		...
		public virtual ProductEntity GetSingleProduct(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(ProductListPriceHistoryEntity.Relations.ProductEntityUsingProductID);
		...
		{
			ProductListPriceHistoryDAO dao = (ProductListPriceHistoryDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ProductListPriceHistoryEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductListPriceHistoryEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "ProductListPriceHistory", resetFKFields, new int[] { (int)ProductListPriceHistoryFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductListPriceHistoryEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 productID, System.DateTime startDate, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)ProductListPriceHistoryFieldIndex.ProductID].ForcedCurrentValueWrite(productID);
				base.Fields[(int)ProductListPriceHistoryFieldIndex.StartDate].ForcedCurrentValueWrite(startDate);
		...
		public static IPrefetchPathElement PrefetchPathProduct
		{
			get
			{
				return new PrefetchPathElement(new AW.Data.CollectionClasses.ProductCollection(),
					(IEntityRelation)GetRelationsForField("Product")[0], (int)AW.Data.EntityType.ProductListPriceHistoryEntity, (int)AW.Data.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ProductListPriceHistoryEntity.CustomProperties;}
		}
		...
		{
			get { return ProductListPriceHistoryEntity.FieldsCustomProperties;}
		}
