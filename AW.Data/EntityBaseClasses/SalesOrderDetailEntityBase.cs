...
namespace AW.Data.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class SalesOrderDetailEntityBase : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected SalesOrderDetailEntityBase() : base()
		{
			InitClassEmpty(null);
		}
		...
		protected SalesOrderDetailEntityBase(System.Int32 salesOrderDetailID, System.Int32 salesOrderID)
		{
		...
		protected SalesOrderDetailEntityBase(System.Int32 salesOrderDetailID, System.Int32 salesOrderID, IPrefetchPath prefetchPathToUse)
		{
		...
		protected SalesOrderDetailEntityBase(System.Int32 salesOrderDetailID, System.Int32 salesOrderID, IValidator validator)
		{
		...
		protected override void AddInternalsToContext()
		{
			if(_salesOrderHeader!=null)
			{
				_salesOrderHeader.ActiveContext = this.ActiveContext;
			}
			if(_specialOfferProduct!=null)
			{
				_specialOfferProduct.ActiveContext = this.ActiveContext;
			}
		}
		...
		private void SetupSyncSalesOrderHeader(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _salesOrderHeader, new PropertyChangedEventHandler( OnSalesOrderHeaderPropertyChanged ), "SalesOrderHeader", SalesOrderDetailEntity.Relations.SalesOrderHeaderEntityUsingSalesOrderID, true, ref _alreadyFetchedSalesOrderHeader, new string[] {  } );
			}
		}
		...
		private void SetupSyncSpecialOfferProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _specialOfferProduct, new PropertyChangedEventHandler( OnSpecialOfferProductPropertyChanged ), "SpecialOfferProduct", SalesOrderDetailEntity.Relations.SpecialOfferProductEntityUsingProductIDSpecialOfferID, true, ref _alreadyFetchedSpecialOfferProduct, new string[] {  } );
			}
		}
