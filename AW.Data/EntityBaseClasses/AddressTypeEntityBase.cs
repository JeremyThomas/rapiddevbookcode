...
namespace AW.Data.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract class AddressTypeEntityBase : EntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			InitClassFetch(addressTypeId, CreateValidator(), new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), null);
		}
		...
		{
			InitClassFetch(addressTypeId, CreateValidator(), new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="addressTypeId">PK value for AddressType which data should be fetched into this AddressType object</param>
		/// <param name="validator">The custom validator object for this AddressTypeEntity</param>
		public AddressTypeEntityBase(System.Int32 addressTypeId, AddressTypeValidator validator)
		{
			InitClassFetch(addressTypeId, validator, new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), null);
		}
		...
		public AddressTypeEntityBase(System.Int32 addressTypeId, AddressTypeValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(addressTypeId, validator, propertyDescriptorFactoryToUse, entityFactoryToUse, null);
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public AddressTypeEntityBase(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		{
			return FetchUsingPK(addressTypeId, null, null);
		}
		...
		{
			return FetchUsingPK(addressTypeId, prefetchPathToUse, null);
		}
		...
		{
			return Fetch(addressTypeId, prefetchPathToUse, contextToUse);
		}
		...
		{
			return Fetch(this.AddressTypeId, null, null);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("AddressTypeEntity", ((AW.Data.EntityType)typeOfEntity).ToString());
		}
		...
		public AW.Data.CollectionClasses.AddressCollection GetMultiAddressCollectionViaCustomerAddress(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedAddressCollectionViaCustomerAddress || forceFetch || _alwaysFetchAddressCollectionViaCustomerAddress) && !base.IsSerializing && !base.IsDeserializing && !EntityCollectionBase.InDesignMode)
			{
				...
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(AddressTypeFieldIndex.AddressTypeId), ComparisonOperator.Equal, this.AddressTypeId));
		...
		{
			return new AddressTypeValidator();
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 addressTypeId, IValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, IPrefetchPath prefetchPathToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);

			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(addressTypeId, prefetchPathToUse, null);
		...
		/// <param name="contextToUse">The context to add the entity to if the fetch was succesful. </param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 addressTypeId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				OnFetch();
		...
		public static IPrefetchPathElement PrefetchPathCustomerAddress
		{
			get
			{
				return new PrefetchPathElement(new AW.Data.CollectionClasses.CustomerAddressCollection(),
					AddressTypeEntity.Relations.CustomerAddressEntityUsingAddressTypeId, 
					(int)AW.Data.EntityType.AddressTypeEntity, (int)AW.Data.EntityType.CustomerAddressEntity, 0, null, null, null, "CustomerAddress", RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathAddressCollectionViaCustomerAddress
		{
			get
			{
				...
				return new PrefetchPathElement(new AW.Data.CollectionClasses.AddressCollection(),
					AddressTypeEntity.Relations.CustomerAddressEntityUsingAddressTypeId,
					(int)AW.Data.EntityType.AddressTypeEntity, (int)AW.Data.EntityType.AddressEntity, 0, null, null, relations, "AddressCollectionViaCustomerAddress", RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathCustomerCollectionViaCustomerAddress
		{
			get
			{
				...
				return new PrefetchPathElement(new AW.Data.CollectionClasses.CustomerCollection(),
					AddressTypeEntity.Relations.CustomerAddressEntityUsingAddressTypeId,
					(int)AW.Data.EntityType.AddressTypeEntity, (int)AW.Data.EntityType.CustomerEntity, 0, null, null, relations, "CustomerCollectionViaCustomerAddress", RelationType.ManyToMany);
			}
		}
		...
		public virtual System.Int32 AddressTypeId
		{
			...
			set	{ SetNewFieldValue((int)AddressTypeFieldIndex.AddressTypeId, value); }
		}
		...
		public virtual System.String Name
		{
			...
			set	{ SetNewFieldValue((int)AddressTypeFieldIndex.Name, value); }
		}
		...
		public virtual System.Guid Rowguid
		{
			...
			set	{ SetNewFieldValue((int)AddressTypeFieldIndex.Rowguid, value); }
		}
		...
		public virtual System.DateTime ModifiedDate
		{
			...
			set	{ SetNewFieldValue((int)AddressTypeFieldIndex.ModifiedDate, value); }
		}
