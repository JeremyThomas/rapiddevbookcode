...
namespace AW.Data.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class SalesTerritoryEntityBase : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected SalesTerritoryEntityBase() : base()
		{
			InitClassEmpty(null);
		}
		...
		protected SalesTerritoryEntityBase(System.Int32 territoryID)
		{
		...
		protected SalesTerritoryEntityBase(System.Int32 territoryID, IPrefetchPath prefetchPathToUse)
		{
		...
		protected SalesTerritoryEntityBase(System.Int32 territoryID, IValidator validator)
		{
		...
		protected override void AddInternalsToContext()
		{
			...
			_countryRegionCollectionViaStateProvince.ActiveContext = this.ActiveContext;
			...
			_customerViewRelatedCollectionViaSalesOrderHeader______.ActiveContext = this.ActiveContext;
