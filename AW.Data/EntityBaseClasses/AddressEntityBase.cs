...
namespace AW.Data.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class AddressEntityBase : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected AddressEntityBase() : base()
		{
			InitClassEmpty(null);
		}
		...
		protected AddressEntityBase(System.Int32 addressID)
		{
		...
		protected AddressEntityBase(System.Int32 addressID, IPrefetchPath prefetchPathToUse)
		{
		...
		protected AddressEntityBase(System.Int32 addressID, IValidator validator)
		{
		...
		public virtual AW.Data.CollectionClasses.SalesOrderHeaderCollection GetMultiSalesOrderHeaders(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedSalesOrderHeaders || forceFetch || _alwaysFetchSalesOrderHeaders) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_salesOrderHeaders.GetMultiManyToOne(this, null, null, null, null, null, null, null, null, filter);
		...
		public virtual AW.Data.CollectionClasses.SalesOrderHeaderCollection GetMultiSalesOrderHeaders_(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedSalesOrderHeaders_ || forceFetch || _alwaysFetchSalesOrderHeaders_) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_salesOrderHeaders_.GetMultiManyToOne(null, this, null, null, null, null, null, null, null, filter);
		...
		protected override void AddInternalsToContext()
		{
			...
			_salesOrderHeaders_.ActiveContext = this.ActiveContext;
			...
			_contactCollectionViaSalesOrderHeader_.ActiveContext = this.ActiveContext;
			_creditCardCollectionViaSalesOrderHeader.ActiveContext = this.ActiveContext;
			_creditCardCollectionViaSalesOrderHeader_.ActiveContext = this.ActiveContext;
			_currencyRateCollectionViaSalesOrderHeader.ActiveContext = this.ActiveContext;
			_currencyRateCollectionViaSalesOrderHeader_.ActiveContext = this.ActiveContext;
			...
			_customerCollectionViaSalesOrderHeader_.ActiveContext = this.ActiveContext;
			_customerViewRelatedCollectionViaSalesOrderHeader.ActiveContext = this.ActiveContext;
			_customerViewRelatedCollectionViaSalesOrderHeader_.ActiveContext = this.ActiveContext;
			_employeeCollectionViaEmployeeAddres.ActiveContext = this.ActiveContext;
			_salesTerritoryCollectionViaSalesOrderHeader.ActiveContext = this.ActiveContext;
			_salesTerritoryCollectionViaSalesOrderHeader_.ActiveContext = this.ActiveContext;
			_shipMethodCollectionViaSalesOrderHeader.ActiveContext = this.ActiveContext;
			_shipMethodCollectionViaSalesOrderHeader_.ActiveContext = this.ActiveContext;
			if(_stateProvince!=null)
			{
				_stateProvince.ActiveContext = this.ActiveContext;
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _stateProvince, new PropertyChangedEventHandler( OnStateProvincePropertyChanged ), "StateProvince", AddressEntity.Relations.StateProvinceEntityUsingStateProvinceID, true, signalRelatedEntity, "Addresses", resetFKFields, new int[] { (int)AddressFieldIndex.StateProvinceID } );		
			_stateProvince = null;
		}
		...
		private void SetupSyncStateProvince(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _stateProvince, new PropertyChangedEventHandler( OnStateProvincePropertyChanged ), "StateProvince", AddressEntity.Relations.StateProvinceEntityUsingStateProvinceID, true, ref _alreadyFetchedStateProvince, new string[] {  } );
			}
		}
