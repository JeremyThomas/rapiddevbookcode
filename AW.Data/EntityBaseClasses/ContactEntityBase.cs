...
namespace AW.Data.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class ContactEntityBase : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected ContactEntityBase() : base()
		{
			InitClassEmpty(null);
		}
		...
		protected ContactEntityBase(System.Int32 contactID)
		{
		...
		protected ContactEntityBase(System.Int32 contactID, IPrefetchPath prefetchPathToUse)
		{
		...
		protected ContactEntityBase(System.Int32 contactID, IValidator validator)
		{
		...
		public virtual AW.Data.CollectionClasses.SalesOrderHeaderCollection GetMultiSalesOrderHeaders(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedSalesOrderHeaders || forceFetch || _alwaysFetchSalesOrderHeaders) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_salesOrderHeaders.GetMultiManyToOne(null, null, this, null, null, null, null, null, null, filter);
