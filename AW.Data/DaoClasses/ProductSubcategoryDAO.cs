...
namespace AW.Data.DaoClasses
{
	...
	/// <summary>General DAO class for the ProductSubcategory Entity. It will perform database oriented actions for a entity of type 'ProductSubcategoryEntity'.</summary>
	public partial class ProductSubcategoryDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public ProductSubcategoryDAO() : base(InheritanceHierarchyType.None, "ProductSubcategoryEntity", new ProductSubcategoryEntityFactory())
		{
		}



		/// <summary>Retrieves in the calling ProductSubcategoryCollection object all ProductSubcategoryEntity objects which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter. </summary>
		...
		/// <summary>Retrieves in the calling ProductSubcategoryCollection object all ProductSubcategoryEntity objects which are related via a relation of type 'm:n' with the passed in ProductModelEntity.</summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="collectionToFill">Collection to fill with the entity objects retrieved</param>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. When set to 0, no limitations are specified.</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
