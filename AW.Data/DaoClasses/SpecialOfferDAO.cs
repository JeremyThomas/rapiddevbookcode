...
namespace AW.Data.DaoClasses
{
	...
	/// <summary>General DAO class for the SpecialOffer Entity. It will perform database oriented actions for a entity of type 'SpecialOfferEntity'.</summary>
	public partial class SpecialOfferDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public SpecialOfferDAO() : base(InheritanceHierarchyType.None, "SpecialOfferEntity", new SpecialOfferEntityFactory())
		{
		}
		...
		/// <summary>Retrieves in the calling SpecialOfferCollection object all SpecialOfferEntity objects which are related via a relation of type 'm:n' with the passed in ProductEntity.</summary>
