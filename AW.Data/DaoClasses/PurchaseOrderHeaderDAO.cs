...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class PurchaseOrderHeaderDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public PurchaseOrderHeaderDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "PurchaseOrderHeaderEntity", new PurchaseOrderHeaderEntityFactory())
		{
		}
		...
		internal PurchaseOrderHeaderDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		public bool GetMultiUsingProductCollectionViaPurchaseOrderDetail(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.PurchaseOrderHeaderEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(PurchaseOrderHeaderEntity.Relations.PurchaseOrderDetailEntityUsingPurchaseOrderID, "PurchaseOrderDetail_");
			relations.Add(PurchaseOrderDetailEntity.Relations.ProductEntityUsingProductID, "PurchaseOrderDetail_", string.Empty, JoinHint.None);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductCollectionViaPurchaseOrderDetail(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.PurchaseOrderHeaderEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(PurchaseOrderHeaderEntity.Relations.PurchaseOrderDetailEntityUsingPurchaseOrderID, "PurchaseOrderDetail_");
