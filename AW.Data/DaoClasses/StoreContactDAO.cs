...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class StoreContactDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public StoreContactDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "StoreContactEntity", new StoreContactEntityFactory())
		{
		}
		...
		internal StoreContactDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
