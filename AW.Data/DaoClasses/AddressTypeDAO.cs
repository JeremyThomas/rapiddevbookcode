...
namespace AW.Data.DaoClasses
{
	...
	public class AddressTypeDAO : DaoBase
	{
		...
		public AddressTypeDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "AddressTypeEntity", new AddressTypeEntityFactory(), new TypeDefaultValue())
		{
		}
