...
namespace AW.Data.DaoClasses
{
	...
	public partial class EmployeeAddressDAO : DaoBase
	{
		...
		public int DeleteMulti(ITransaction containingTransaction, IEntity addressInstance, IEntity employeeInstance)
		{
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntity entityWithNewValues, ITransaction containingTransaction, IEntity addressInstance, IEntity employeeInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.EmployeeAddressEntity);
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(IEntity addressInstance, IEntity employeeInstance, IEntityFields fieldsToReturn)
		{
