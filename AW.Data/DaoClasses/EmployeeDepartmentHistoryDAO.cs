...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class EmployeeDepartmentHistoryDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public EmployeeDepartmentHistoryDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "EmployeeDepartmentHistoryEntity", new EmployeeDepartmentHistoryEntityFactory())
		{
		}
		...
		internal EmployeeDepartmentHistoryDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
