...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class IndividualDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public IndividualDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "IndividualEntity", new IndividualEntityFactory())
		{
		}
		...
		internal IndividualDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
