...
namespace AW.Data.DaoClasses
{
	...
	public class IndividualDAO : DaoBase
	{
		...
		public IndividualDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "IndividualEntity", new IndividualEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, IEntity contactInstance, int pageNumber, int pageSize)
		{
		...
		public int DeleteMulti(ITransaction containingTransaction, IEntity contactInstance)
		{
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntity entityWithNewValues, ITransaction containingTransaction, IEntity contactInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.IndividualEntity);
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(IEntity contactInstance, IEntityFields fieldsToReturn)
		{
