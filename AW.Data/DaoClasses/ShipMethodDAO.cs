...
namespace AW.Data.DaoClasses
{
	...
	public class ShipMethodDAO : DaoBase
	{
		...
		public ShipMethodDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "ShipMethodEntity", new ShipMethodEntityFactory(), new TypeDefaultValue())
		{
		}
