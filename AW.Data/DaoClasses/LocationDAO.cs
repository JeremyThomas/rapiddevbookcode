...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class LocationDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public LocationDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "LocationEntity", new LocationEntityFactory())
		{
		}
		...
		internal LocationDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		public bool GetMultiUsingProductCollectionViaProductInventory(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.LocationEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(LocationEntity.Relations.ProductInventoryEntityUsingLocationID, "ProductInventory_");
			relations.Add(ProductInventoryEntity.Relations.ProductEntityUsingProductID, "ProductInventory_", string.Empty, JoinHint.None);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductCollectionViaProductInventory(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.LocationEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(LocationEntity.Relations.ProductInventoryEntityUsingLocationID, "ProductInventory_");
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingWorkOrderCollectionViaWorkOrderRouting(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity workOrderInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.LocationEntity);
			RelationCollection relations = new RelationCollection();
