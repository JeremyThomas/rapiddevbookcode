...
namespace AW.Data.DaoClasses
{
	...
	public class ProductDAO : DaoBase
	{
		...
		public ProductDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "ProductEntity", new ProductEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		public bool GetMultiUsingSpecialOfferCollectionViaSpecialOfferProduct(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IEntity specialOfferInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ProductEntity);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingSpecialOfferCollectionViaSpecialOfferProduct(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IEntity specialOfferInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ProductEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(ProductEntity.Relations.SpecialOfferProductEntityUsingProductId, "SpecialOfferProduct_");
