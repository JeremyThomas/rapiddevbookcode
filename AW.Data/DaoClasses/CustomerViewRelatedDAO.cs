...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class CustomerViewRelatedDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public CustomerViewRelatedDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "CustomerViewRelatedEntity", new CustomerViewRelatedEntityFactory())
		{
		}
		...
		internal CustomerViewRelatedDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
