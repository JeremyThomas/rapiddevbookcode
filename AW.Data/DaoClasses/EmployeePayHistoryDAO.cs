...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class EmployeePayHistoryDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public EmployeePayHistoryDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "EmployeePayHistoryEntity", new EmployeePayHistoryEntityFactory())
		{
		}
		...
		internal EmployeePayHistoryDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
