...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class StateProvinceDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public StateProvinceDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "StateProvinceEntity", new StateProvinceEntityFactory())
		{
		}
		...
		internal StateProvinceDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
