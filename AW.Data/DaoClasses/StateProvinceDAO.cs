...
namespace AW.Data.DaoClasses
{
	...
	/// <summary>General DAO class for the StateProvince Entity. It will perform database oriented actions for a entity of type 'StateProvinceEntity'.</summary>
	public partial class StateProvinceDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public StateProvinceDAO() : base(InheritanceHierarchyType.None, "StateProvinceEntity", new StateProvinceEntityFactory())
		{
		}



		/// <summary>Retrieves in the calling StateProvinceCollection object all StateProvinceEntity objects which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter. </summary>
