...
namespace AW.Data.DaoClasses
{
	...
	public class StateProvinceDAO : DaoBase
	{
		...
		public StateProvinceDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "StateProvinceEntity", new StateProvinceEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IPredicateExpression filter, IEntity countryRegionInstance, int pageNumber, int pageSize)
		{
