...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class VendorAddressDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public VendorAddressDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "VendorAddressEntity", new VendorAddressEntityFactory())
		{
		}
		...
		internal VendorAddressDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
