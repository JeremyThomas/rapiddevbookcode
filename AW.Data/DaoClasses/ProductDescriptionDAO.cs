...
namespace AW.Data.DaoClasses
{
	...
	/// </summary>
	public partial class ProductDescriptionDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public ProductDescriptionDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "ProductDescriptionEntity", new ProductDescriptionEntityFactory())
		{
		}
		...
		internal ProductDescriptionDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ProductDescriptionEntity);
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductModelCollectionViaProductModelProductDescriptionCulture(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productModelInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ProductDescriptionEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(ProductDescriptionEntity.Relations.ProductModelProductDescriptionCultureEntityUsingProductDescriptionID, "ProductModelProductDescriptionCulture_");
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingProductModelCollectionViaProductModelProductDescriptionCulture(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity productModelInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(AW.Data.EntityType.ProductDescriptionEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(ProductDescriptionEntity.Relations.ProductModelProductDescriptionCultureEntityUsingProductDescriptionID, "ProductModelProductDescriptionCulture_");
