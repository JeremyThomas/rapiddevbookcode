...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditProductCategory.ascx.cs" Inherits="Controls_EditProductCategory" %>
<llblgenpro:LLBLGenProDataSource ID="_ProductCategoryDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.ProductCategoryCollection, AW.Data" LivePersistence="False" OnPerformSelect="_ProductCategoryDS_PerformSelect" OnPerformWork="_ProductCategoryDS_PerformWork"/>
<asp:FormView ID="frmEditProductCategory" DataKeyNames="ProductCategoryID" runat="server" DefaultMode="insert" DataSourceID="_ProductCategoryDS" Cellpadding="0" OnItemCommand="frmEditProductCategory_ItemCommand" OnItemCreated="frmEditProductCategory_ItemCreated">
<InsertItemTemplate>
...
<EditItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:Label ID="lblProductCategoryID" runat="server" Text='<%# Bind("ProductCategoryID") %>'/>			</td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this ProductCategory instance with PK values: "  + "ProductCategoryID: " + Eval("ProductCategoryID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
