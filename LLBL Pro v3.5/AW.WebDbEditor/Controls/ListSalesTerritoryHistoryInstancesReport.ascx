...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSalesTerritoryHistoryInstancesReport.ascx.cs" Inherits="Controls_ListSalesTerritoryHistoryInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\SalesTerritoryHistoryReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_SalesTerritoryHistoryDS" Name="SalesTerritoryHistory" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
