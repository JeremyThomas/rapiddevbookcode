...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListCustomerViewRelatedInstancesReport.ascx.cs" Inherits="Controls_ListCustomerViewRelatedInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\CustomerViewRelatedReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_CustomerViewRelatedDS" Name="CustomerViewRelated" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
