...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSalesReasonInstances.ascx.cs" Inherits="Controls_ListSalesReasonInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="SalesReasonID" 
					DataSourceID="_SalesReasonDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
		...
		<asp:TemplateField HeaderText="ReasonType" SortExpression="ReasonType"  HeaderStyle-HorizontalAlign="Left" ItemStyle-CssClass="ColumnContent" ItemStyle-Wrap="false" >
			<ItemTemplate>
				<asp:Label ID="lblReasonType" runat="server" Text='<%# Bind("ReasonType") %>'/>
			</ItemTemplate>
		</asp:TemplateField>
		<asp:TemplateField HeaderText="SalesReasonID" SortExpression="SalesReasonID" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" ItemStyle-CssClass="ColumnContent" ItemStyle-Wrap="false" >
			<ItemTemplate>
				<asp:Label ID="lblSalesReasonID" runat="server" Text='<%# Bind("SalesReasonID") %>'/>
			</ItemTemplate>
		</asp:TemplateField>
