...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditDepartment.ascx.cs" Inherits="Controls_EditDepartment" %>
<llblgenpro:LLBLGenProDataSource ID="_DepartmentDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.DepartmentCollection, AW.Data" LivePersistence="False" OnPerformSelect="_DepartmentDS_PerformSelect" OnPerformWork="_DepartmentDS_PerformWork"/>
<asp:FormView ID="frmEditDepartment" DataKeyNames="DepartmentID" runat="server" DefaultMode="insert" DataSourceID="_DepartmentDS" Cellpadding="0" OnItemCommand="frmEditDepartment_ItemCommand" OnItemCreated="frmEditDepartment_ItemCreated">
<InsertItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:textbox TextMode="MultiLine" Columns="50" Rows="2" id="tbxGroupName" runat="server" maxlength="50" Text='<%# Bind("GroupName") %>' ValidationGroup="InsertValidations"  CssClass="required"/> *  <asp:RequiredFieldValidator ValidationGroup="InsertValidations" ID="reqGroupName" runat="server" ControlToValidate="tbxGroupName" Display="Dynamic" ErrorMessage="Required" />
...
<EditItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
		...
		<tr>
			...
			<td class="content">
				<asp:textbox TextMode="MultiLine" Columns="50" Rows="2" id="tbxGroupName" runat="server" maxlength="50" Text='<%# Bind("GroupName") %>' ValidationGroup="EditValidations"  CssClass="required"/> *  <asp:RequiredFieldValidator ValidationGroup="EditValidations" ID="reqGroupName" runat="server" ControlToValidate="tbxGroupName" Display="Dynamic" ErrorMessage="Required" />
...
<ItemTemplate>
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			...
			<td class="content" width="100%">
			<asp:Label ID="lblGroupName" runat="server" Text='<%# Bind("GroupName") %>'/></td>
			<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
		</tr>
		<tr>
			<td width="20"  nowrap="nowrap" class="content">&nbsp;</td>
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this Department instance with PK values: "  + "DepartmentID: " + Eval("DepartmentID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
