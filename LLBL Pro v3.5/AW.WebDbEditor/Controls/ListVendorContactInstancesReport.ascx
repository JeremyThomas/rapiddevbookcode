...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListVendorContactInstancesReport.ascx.cs" Inherits="Controls_ListVendorContactInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\VendorContactReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_VendorContactDS" Name="VendorContact" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
