...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListWorkOrderInstancesReport.ascx.cs" Inherits="Controls_ListWorkOrderInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\WorkOrderReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_WorkOrderDS" Name="WorkOrder" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
