		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncContact(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _contact, new PropertyChangedEventHandler( OnContactPropertyChanged ), "Contact", AW.Data.RelationClasses.StaticContactCreditCardRelations.ContactEntityUsingContactIDStatic, true, ref _alreadyFetchedContact, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _creditCard, new PropertyChangedEventHandler( OnCreditCardPropertyChanged ), "CreditCard", AW.Data.RelationClasses.StaticContactCreditCardRelations.CreditCardEntityUsingCreditCardIDStatic, true, signalRelatedEntity, "ContactCreditCards", resetFKFields, new int[] { (int)ContactCreditCardFieldIndex.CreditCardID } );		
			_creditCard = null;
		}
		...
		private void SetupSyncCreditCard(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _creditCard, new PropertyChangedEventHandler( OnCreditCardPropertyChanged ), "CreditCard", AW.Data.RelationClasses.StaticContactCreditCardRelations.CreditCardEntityUsingCreditCardIDStatic, true, ref _alreadyFetchedCreditCard, new string[] {  } );
			}
		}
