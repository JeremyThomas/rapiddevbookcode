...
namespace AW.Winforms.Helpers.WPF
{
	...
	public abstract class LinkedConverter: MarkupExtension, IValueConverter
	{
		...
		/// <summary>
		/// An optional <see cref="System.Type"/> value to pass to the <see cref="InstanceConvert"/> method of the chained converter if the <see cref="Link"/>
		/// property is set.
		/// </summary>
		/// <remarks>
	...
	public abstract class BoolToEnumConverter<TEnum> : LinkedConverter where TEnum : struct
	{
		...
		/// <summary>
		/// Convert a <c>true</c> or <c>false</c> value to corresponding values of the enum specified by <see cref="TrueValue"/> or <see cref="FalseValue"/>.
		/// </summary>
