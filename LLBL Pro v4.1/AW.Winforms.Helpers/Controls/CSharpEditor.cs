...
namespace AW.Winforms.Helpers.Controls
{
  ...
  /// </summary>
    public partial class CSharpEditor : Form
    {
                ...
                if (e.ColumnIndex == 1)
                    ...
                    switch (item.type)
                    {
                        case ExplorerItemType.Class:
                            e.Value = global::AW.Winforms.Helpers.Properties.Resources.class_libraries;
                            return;
                        case ExplorerItemType.Method:
                            e.Value = global::AW.Winforms.Helpers.Properties.Resources.box;
                            return;
                        case ExplorerItemType.Event:
                            e.Value = global::AW.Winforms.Helpers.Properties.Resources.lightning;
                            return;
                        case ExplorerItemType.Property:
                            e.Value = global::AW.Winforms.Helpers.Properties.Resources.property;
                            return;
                    }
            }
            catch{;}
