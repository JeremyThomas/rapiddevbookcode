...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListPurchaseOrderHistoryInstances.ascx.cs" Inherits="Controls_ListPurchaseOrderHistoryInstances" %>
...
<llblgenpro:LLBLGenProDataSource ID="_PurchaseOrderHistoryDS" runat="server" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.PurchaseOrderHistoryCollection, AW.Data" CacheLocation="Session" EnablePaging="True" />
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="TransactionID" 
					DataSourceID="_PurchaseOrderHistoryDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
