...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditSalesOrderHistory.ascx.cs" Inherits="Controls_EditSalesOrderHistory" %>
<llblgenpro:LLBLGenProDataSource ID="_SalesOrderHistoryDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.SalesOrderHistoryCollection, AW.Data" LivePersistence="False" OnPerformSelect="_SalesOrderHistoryDS_PerformSelect" OnPerformWork="_SalesOrderHistoryDS_PerformWork"/>
<asp:FormView ID="frmEditSalesOrderHistory" DataKeyNames="TransactionID" runat="server" DefaultMode="insert" DataSourceID="_SalesOrderHistoryDS" Cellpadding="0" OnItemCommand="frmEditSalesOrderHistory_ItemCommand" OnItemCreated="frmEditSalesOrderHistory_ItemCreated">
<InsertItemTemplate>
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this SalesOrderHistory instance with PK values: "  + "TransactionID: " + Eval("TransactionID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
