...
public partial class Controls_ListCustomerInstancesReport : System.Web.UI.UserControl, IListControl
{
			...
			case "SalesTerritoryEntity":
				switch(name)
				{
					case "Customers":
						...
						dsFilter.AddWithAnd(CustomerFields.TerritoryID == ((SalesTerritoryEntity)containingEntity).TerritoryID);
						_CustomerDS.FilterToUse = dsFilter;
