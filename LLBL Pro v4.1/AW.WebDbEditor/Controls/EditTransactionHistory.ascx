...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditTransactionHistory.ascx.cs" Inherits="Controls_EditTransactionHistory" %>
<llblgenpro:LLBLGenProDataSource ID="_TransactionHistoryDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.TransactionHistoryCollection, AW.Data" LivePersistence="False" OnPerformSelect="_TransactionHistoryDS_PerformSelect" OnPerformWork="_TransactionHistoryDS_PerformWork"/>
<asp:FormView ID="frmEditTransactionHistory" DataKeyNames="TransactionID" runat="server" DefaultMode="insert" DataSourceID="_TransactionHistoryDS" Cellpadding="0" OnItemCommand="frmEditTransactionHistory_ItemCommand" OnItemCreated="frmEditTransactionHistory_ItemCreated">
<InsertItemTemplate>
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this TransactionHistory instance with PK values: "  + "TransactionID: " + Eval("TransactionID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
