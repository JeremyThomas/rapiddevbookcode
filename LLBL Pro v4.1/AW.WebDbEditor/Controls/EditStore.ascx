...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditStore.ascx.cs" Inherits="Controls_EditStore" %>
<llblgenpro:LLBLGenProDataSource ID="_StoreDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.StoreCollection, AW.Data" LivePersistence="False" OnPerformSelect="_StoreDS_PerformSelect" OnPerformWork="_StoreDS_PerformWork"/>
<asp:FormView ID="frmEditStore" DataKeyNames="CustomerID" runat="server" DefaultMode="insert" DataSourceID="_StoreDS" Cellpadding="0" OnItemCommand="frmEditStore_ItemCommand" OnItemCreated="frmEditStore_ItemCreated">
<InsertItemTemplate>
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this Store instance with PK values: "  + "CustomerID: " + Eval("CustomerID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
