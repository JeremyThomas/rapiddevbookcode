...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _contact, new PropertyChangedEventHandler( OnContactPropertyChanged ), "Contact", AW.Data.RelationClasses.StaticVendorContactRelations.ContactEntityUsingContactIDStatic, true, signalRelatedEntity, "VendorContacts", resetFKFields, new int[] { (int)VendorContactFieldIndex.ContactID } );		
			_contact = null;
		}
		...
		private void SetupSyncContact(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _contact, new PropertyChangedEventHandler( OnContactPropertyChanged ), "Contact", AW.Data.RelationClasses.StaticVendorContactRelations.ContactEntityUsingContactIDStatic, true, ref _alreadyFetchedContact, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _contactType, new PropertyChangedEventHandler( OnContactTypePropertyChanged ), "ContactType", AW.Data.RelationClasses.StaticVendorContactRelations.ContactTypeEntityUsingContactTypeIDStatic, true, signalRelatedEntity, "VendorContacts", resetFKFields, new int[] { (int)VendorContactFieldIndex.ContactTypeID } );		
			_contactType = null;
		}
		...
		private void SetupSyncContactType(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _contactType, new PropertyChangedEventHandler( OnContactTypePropertyChanged ), "ContactType", AW.Data.RelationClasses.StaticVendorContactRelations.ContactTypeEntityUsingContactTypeIDStatic, true, ref _alreadyFetchedContactType, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", AW.Data.RelationClasses.StaticVendorContactRelations.VendorEntityUsingVendorIDStatic, true, signalRelatedEntity, "VendorContacts", resetFKFields, new int[] { (int)VendorContactFieldIndex.VendorID } );		
			_vendor = null;
		}
		...
		private void SetupSyncVendor(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", AW.Data.RelationClasses.StaticVendorContactRelations.VendorEntityUsingVendorIDStatic, true, ref _alreadyFetchedVendor, new string[] {  } );
			}
		}
