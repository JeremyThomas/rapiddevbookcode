...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ShiftEntity(System.Byte shiftID, IPrefetchPath prefetchPathToUse):base("ShiftEntity")
		{
		...
		public virtual AW.Data.CollectionClasses.EmployeeDepartmentHistoryCollection GetMultiEmployeeDepartmentHistories(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedEmployeeDepartmentHistories || forceFetch || _alwaysFetchEmployeeDepartmentHistories) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_employeeDepartmentHistories.GetMultiManyToOne(null, null, this, filter);
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Byte shiftID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
		...
		private void InitClassMembers()
		{
			...
			_employeeDepartmentHistories.SetContainingEntityInfo(this, "Shift");
		...
		{
			get { return new PrefetchPathElement(new AW.Data.CollectionClasses.EmployeeDepartmentHistoryCollection(), (IEntityRelation)GetRelationsForField("EmployeeDepartmentHistories")[0], (int)AW.Data.EntityType.ShiftEntity, (int)AW.Data.EntityType.EmployeeDepartmentHistoryEntity, 0, null, null, null, "EmployeeDepartmentHistories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// MS_Description: Shift end time.<br/>Shift end time.</summary>
		...
		/// MS_Description: Shift description.<br/>Shift description.</summary>
