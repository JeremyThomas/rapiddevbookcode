...
namespace Northwind.DAL.EntityClasses
{
			...
			
	{
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_territory!=null)
			{
				_territory.ActiveContext = this.ActiveContext;
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", Relations.EmployeeEntityUsingEmployeeId, true, signalRelatedEntity, "EmployeeTerritories", resetFKFields, new int[] { (int)EmployeeTerritoryFieldIndex.EmployeeId } );
			_employee = null;
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _territory, new PropertyChangedEventHandler( OnTerritoryPropertyChanged ), "Territory", Relations.TerritoryEntityUsingTerritoryId, true, signalRelatedEntity, "EmployeeTerritories", resetFKFields, new int[] { (int)EmployeeTerritoryFieldIndex.TerritoryId } );
			_territory = null;
		}
		...
		private void SetupSyncTerritory(IEntity2 relatedEntity)
		{
			if(_territory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _territory, new PropertyChangedEventHandler( OnTerritoryPropertyChanged ), "Territory", Relations.TerritoryEntityUsingTerritoryId, true, new string[] {  } );
			}
		}
