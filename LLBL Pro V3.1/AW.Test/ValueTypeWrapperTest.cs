...
namespace AW.Tests
{
	...
	public class ValueTypeWrapperTest
	{
		...
		public List<ValueTypeWrapper<T>> CreateWrapperForBindingTestHelper<T>(params T[] values)
		{
		...
		///</summary>
		public List<ValueTypeWrapper<T>> CreateWrapperForBindingTestHelper<T>(IEnumerable<T> values)
		{
