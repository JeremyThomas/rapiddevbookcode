...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_productPhoto!=null)
			{
				_productPhoto.ActiveContext = this.ActiveContext;
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductProductPhotoEntity.Relations.ProductEntityUsingProductID, true, signalRelatedEntity, "ProductProductPhotos", resetFKFields, new int[] { (int)ProductProductPhotoFieldIndex.ProductID } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductProductPhotoEntity.Relations.ProductEntityUsingProductID, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private void SetupSyncProductPhoto(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _productPhoto, new PropertyChangedEventHandler( OnProductPhotoPropertyChanged ), "ProductPhoto", ProductProductPhotoEntity.Relations.ProductPhotoEntityUsingProductPhotoID, true, ref _alreadyFetchedProductPhoto, new string[] {  } );
			}
		}
