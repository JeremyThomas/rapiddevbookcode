...
namespace AW.Data.EntityClasses
{
			...
			
	{
		...
		public WorkOrderHistoryEntity() : base()
		{
			InitClassEmpty(null);
		}
		...
		public static new WorkOrderHistoryEntity FetchPolymorphic(ITransaction transactionToUse, System.Int32 transactionID, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			fields[(int)WorkOrderHistoryFieldIndex.TransactionID].ForcedCurrentValueWrite(transactionID);
		...
		private void InitClassEmpty(IValidator validatorToUse)
		{
			...
			{
				this.Fields[(int)WorkOrderHistoryFieldIndex.TransactionType].ForcedCurrentValueWrite("W");
			}
		...
		{
			get { return "WorkOrderHistoryEntity";}
		}
