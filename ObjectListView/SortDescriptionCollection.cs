...
namespace JesseJohnston
{
	...
	internal class SortDescriptionCollection : ICollection<SortDescription>
	{
		...
		private List<SortDescription> descriptions = new List<SortDescription>();
		...
		public SortDescriptionCollection(Type targetType)
		{
			...
			this.descriptions = new List<SortDescription>();
		}
		/// <summary>
		/// Initializes a new instance of the <see cref="SortDescriptionCollection"/> class.
		/// </summary>
		...
		public SortDescriptionCollection(Type targetType, ListSortDescriptionCollection sorts)
		{
			...
			if (sorts != null)
			{
				foreach (ListSortDescription desc in sorts)
					this.Add(new SortDescription(desc.PropertyDescriptor, desc.SortDirection));
			}
		}
		...
		public ListSortDescriptionCollection GetListSortDescriptions()
		{
			...
			ListSortDescription[] sorts = new ListSortDescription[this.descriptions.Count];
			for (int i = 0; i < this.descriptions.Count ; i++)
			{
				SortDescription desc = this.descriptions[i];
		...
		public void Add(SortDescription item)
		{
			...
			if (item.PropertyDescriptor == null && TypeDescriptor.GetProperties(this.targetType).Find(item.PropertyName, true) == null)
