  ...
  public class CustomerQueriesTest
  {
    ...
    public void GetCustomerListAnonymousLinqTest()
    {
      ...
      Assert.AreEqual(MaxNumberOfItemsToReturn, customerListAnonymousLinq.Count());
		...
		/// <summary>
		/// Gets the customer list linqed typed list test.
		/// </summary>
		/// <remarks>https://stackoverflow.com/questions/5371425/how-to-change-adventureworks-database-collation-on-sql-server-2005 use AdventureWorksDBCI.msi</remarks>
		/// <autogeneratedoc />
