...
namespace Northwind.DAL.FactoryClasses
{
	...
	public static partial class EntityFieldsFactory
	{
		...
		private static IEntityFields2 CreateAlphabeticalListOfProductTypedViewEntityFields()
		{
			IEntityFields2 fieldsToReturn = new EntityFields2((int)AlphabeticalListOfProductFieldIndex.AmountOfFields, null, FieldInfoProviderSingleton.GetInstance().GetFieldIndexes("AlphabeticalListOfProductTypedView"));
		...
		private static IEntityFields2 CreateInvoiceTypedViewEntityFields()
		{
			IEntityFields2 fieldsToReturn = new EntityFields2((int)InvoiceFieldIndex.AmountOfFields, null, FieldInfoProviderSingleton.GetInstance().GetFieldIndexes("InvoiceTypedView"));
