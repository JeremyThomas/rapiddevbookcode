...
namespace Northwind.DAL.Oracle
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitCategoryEntityMappings()
		{
			...
			this.AddElementFieldMapping("CategoryEntity", "CategoryId", "CATEGORYID", false, "Decimal", 0, 10, 0, false, "", new Northwind.DAL.CategoryConverter(), typeof(System.Int64), 0);
		...
		private void InitProductEntityMappings()
		{
			...
			this.AddElementFieldMapping("ProductEntity", "CategoryId", "CATEGORYID", true, "Decimal", 0, 10, 0, false, "", new Northwind.DAL.CategoryConverter(), typeof(System.Int64), 0);
