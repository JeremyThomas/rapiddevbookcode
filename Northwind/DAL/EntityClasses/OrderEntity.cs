...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void AddInternalsToContext()
		{
			...
			{
				_orderDetails.ActiveContext = this.ActiveContext;
			}
			if(_customer!=null)
			{
			...
			if(_shipper!=null)
			{
				_shipper.ActiveContext = this.ActiveContext;
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", Relations.CustomerEntityUsingCustomerId, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.CustomerId } );
			_customer = null;
		}
		...
		private void SetupSyncCustomer(IEntity2 relatedEntity)
		{
			if(_customer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", Relations.CustomerEntityUsingCustomerId, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", Relations.EmployeeEntityUsingEmployeeId, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.EmployeeId } );
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntity2 relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", Relations.EmployeeEntityUsingEmployeeId, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", Relations.ShipperEntityUsingShipVia, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrderFieldIndex.ShipVia } );
			_shipper = null;
		}

		/// <summary> setups the sync logic for member _shipper</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncShipper(IEntity2 relatedEntity)
		{
			if(_shipper!=relatedEntity)
			{
				DesetupSyncShipper(true, true);
				_shipper = (ShipperEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", Relations.ShipperEntityUsingShipVia, true, new string[] {  } );
			}
		}
