...
namespace Northwind.Client.Winforms
{
  ...
  public class CustomerWithOrdersDataScope : DataScope
  {
    ...
    {
      return CommitChanges(u => _dalService.CommitCustomerManagerChanges((UnitOfWork2) u));
    }
    ...
    /// <summary>
    ///   The implementation of the fetch method. In this method, fetch the data for the scope. Use the TrackQuery methods to
    ///   make sure
    ...
    /// <summary>
    ///   Called when toDelete is about to be deleted. Use this method to specify work to be done by the scope to avoid FK
    ///   constraint issues.
    ///   workData is meant to collect this work. It can either be additional entities to delete prior to 'toDelete', or a list
    ///   of
