		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AW.Data.RelationClasses.StaticBillOfMaterialRelations.ProductEntityUsingComponentIDStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private void SetupSyncProduct_(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product_, new PropertyChangedEventHandler( OnProduct_PropertyChanged ), "Product_", AW.Data.RelationClasses.StaticBillOfMaterialRelations.ProductEntityUsingProductAssemblyIDStatic, true, ref _alreadyFetchedProduct_, new string[] {  } );
			}
		}
