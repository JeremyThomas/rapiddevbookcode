		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncSalesTerritory(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", AW.Data.RelationClasses.StaticCustomerRelations.SalesTerritoryEntityUsingTerritoryIDStatic, true, ref _alreadyFetchedSalesTerritory, new string[] {  } );
			}
		}
