...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListProductListPriceHistoryInstancesReport.ascx.cs" Inherits="Controls_ListProductListPriceHistoryInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\ProductListPriceHistoryReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_ProductListPriceHistoryDS" Name="ProductListPriceHistory" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
