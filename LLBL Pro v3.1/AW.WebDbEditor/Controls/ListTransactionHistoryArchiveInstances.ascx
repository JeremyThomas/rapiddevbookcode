...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListTransactionHistoryArchiveInstances.ascx.cs" Inherits="Controls_ListTransactionHistoryArchiveInstances" %>
...
<llblgenpro:LLBLGenProDataSource ID="_TransactionHistoryArchiveDS" runat="server" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.TransactionHistoryArchiveCollection, AW.Data" CacheLocation="Session" EnablePaging="True" />
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="TransactionID" 
					DataSourceID="_TransactionHistoryArchiveDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
