...
public partial class Controls_ListProductListPriceHistoryInstances : System.Web.UI.UserControl, IListControl
{
	...
	protected void btnAddNew_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("~/AddNew.aspx?EntityType=" + (int)EntityType.ProductListPriceHistoryEntity + additionalFiltersAsString);
	}
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
		...
		// export to excel
        GridViewExportUtils.Export("ProductListPriceHistory.xls", theGrid);
    }
	...
	protected void theGrid_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		...
		ProductListPriceHistoryEntity selectedEntity = (ProductListPriceHistoryEntity)_ProductListPriceHistoryDS.EntityCollection[index];
		...
		{
			case "EditExisting":
				Response.Redirect("~/EditExisting.aspx?EntityType=" + (int)EntityType.ProductListPriceHistoryEntity + pkFieldsAndValues.ToString());
				break;
			case "ViewExisting":
				Response.Redirect("~/ViewExisting.aspx?EntityType=" + (int)EntityType.ProductListPriceHistoryEntity + pkFieldsAndValues.ToString());
				break;
		}
	}
...
IPredicateExpression dsFilter;
			...
			case "ProductEntity":
				switch(name)
				{
					case "ProductListPriceHistories":
						...
						dsFilter.AddWithAnd(ProductListPriceHistoryFields.ProductID == ((ProductEntity)containingEntity).ProductID);
						_ProductListPriceHistoryDS.FilterToUse = dsFilter;
	...
	{
		set { _ProductListPriceHistoryDS.FilterToUse = value; }
	}
