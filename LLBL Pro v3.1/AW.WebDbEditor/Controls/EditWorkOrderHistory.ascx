...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditWorkOrderHistory.ascx.cs" Inherits="Controls_EditWorkOrderHistory" %>
<llblgenpro:LLBLGenProDataSource ID="_WorkOrderHistoryDS" runat="server" MaxNumberOfItemsToReturn="1" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.WorkOrderHistoryCollection, AW.Data" LivePersistence="False" OnPerformSelect="_WorkOrderHistoryDS_PerformSelect" OnPerformWork="_WorkOrderHistoryDS_PerformWork"/>
<asp:FormView ID="frmEditWorkOrderHistory" DataKeyNames="TransactionID" runat="server" DefaultMode="insert" DataSourceID="_WorkOrderHistoryDS" Cellpadding="0" OnItemCommand="frmEditWorkOrderHistory_ItemCommand" OnItemCreated="frmEditWorkOrderHistory_ItemCreated">
<InsertItemTemplate>
	...
	<table cellpadding="3" border="0" cellspacing="1" class="formtexts" width="700">
		...
		<tr>
			<td colspan="3" class="content">
				...
				<asp:Button ID="btnDelete" runat="server" CausesValidation="True" CommandName="DeleteExisting" Text="Delete and Home" SkinId="ButtonSkin" visible="false" OnClientClick='<%# "return confirm(\"Are you sure you want to delete this WorkOrderHistory instance with PK values: "  + "TransactionID: " + Eval("TransactionID") + " ?\");" %>'/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
