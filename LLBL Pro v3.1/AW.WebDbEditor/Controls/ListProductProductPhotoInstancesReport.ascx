...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListProductProductPhotoInstancesReport.ascx.cs" Inherits="Controls_ListProductProductPhotoInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\ProductProductPhotoReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_ProductProductPhotoDS" Name="ProductProductPhoto" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
