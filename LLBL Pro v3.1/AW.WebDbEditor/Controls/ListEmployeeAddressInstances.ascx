...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListEmployeeAddressInstances.ascx.cs" Inherits="Controls_ListEmployeeAddressInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="AddressID, EmployeeID" 
					DataSourceID="_EmployeeAddressDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
