...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListProductCostHistoryInstances.ascx.cs" Inherits="Controls_ListProductCostHistoryInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="ProductID, StartDate" 
					DataSourceID="_ProductCostHistoryDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
