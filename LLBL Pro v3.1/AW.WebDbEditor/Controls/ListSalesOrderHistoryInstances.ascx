...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSalesOrderHistoryInstances.ascx.cs" Inherits="Controls_ListSalesOrderHistoryInstances" %>
...
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="TransactionID" 
					DataSourceID="_SalesOrderHistoryDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
