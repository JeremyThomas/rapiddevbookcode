...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListCurrencyRateInstancesReport.ascx.cs" Inherits="Controls_ListCurrencyRateInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\CurrencyRateReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_CurrencyRateDS" Name="CurrencyRate" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
