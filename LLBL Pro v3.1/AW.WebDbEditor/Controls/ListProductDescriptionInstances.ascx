...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListProductDescriptionInstances.ascx.cs" Inherits="Controls_ListProductDescriptionInstances" %>
...
<llblgenpro:LLBLGenProDataSource ID="_ProductDescriptionDS" runat="server" DataContainerType="EntityCollection" EntityCollectionTypeName="AW.Data.CollectionClasses.ProductDescriptionCollection, AW.Data" CacheLocation="Session" EnablePaging="True" />
<asp:GridView ID="theGrid" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False" DataKeyNames="ProductDescriptionID" 
					DataSourceID="_ProductDescriptionDS" OnRowCommand="theGrid_RowCommand">
	<Columns>
		...
		<asp:TemplateField HeaderText="ProductDescriptionID" SortExpression="ProductDescriptionID" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" ItemStyle-CssClass="ColumnContent" ItemStyle-Wrap="false" >
			<ItemTemplate>
				<asp:Label ID="lblProductDescriptionID" runat="server" Text='<%# Bind("ProductDescriptionID") %>'/>
			</ItemTemplate>
		</asp:TemplateField>
