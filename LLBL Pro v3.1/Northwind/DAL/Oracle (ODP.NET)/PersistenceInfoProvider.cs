...
namespace Northwind.DAL.Oracle
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitEmployeeEntityMappings()
		{
			...
			this.AddElementFieldMapping( "EmployeeEntity", "EmployeeId", "EMPLOYEEID", false, "Decimal", 0, 0, 10, true, "DBO_NORTHWIND.EMPLOYEES_EMPLOYEEID_SEQ",  new AW.Helper.TypeConverters.IntegerNonNullNumericConverter(), typeof(System.Int64), 4 );
			...
			this.AddElementFieldMapping( "EmployeeEntity", "ReportsTo", "REPORTSTO", true, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNumericConverter(), typeof(System.Int64), 15 );
		...
		private void InitEmployeeTerritoryEntityMappings()
		{
			...
			this.AddElementFieldMapping( "EmployeeTerritoryEntity", "EmployeeId", "EMPLOYEEID", false, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNonNullNumericConverter(), typeof(System.Int64), 0 );
		...
		private void InitOrderEntityMappings()
		{
			...
			this.AddElementFieldMapping( "OrderEntity", "EmployeeId", "EMPLOYEEID", true, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNumericConverter(), typeof(System.Int64), 1 );
			...
			this.AddElementFieldMapping( "OrderEntity", "OrderId", "ORDERID", false, "Decimal", 0, 0, 10, true, "DBO_NORTHWIND.ORDERS_ORDERID_SEQ",  new AW.Helper.TypeConverters.IntegerNonNullNumericConverter(), typeof(System.Int64), 4 );
			...
			this.AddElementFieldMapping( "OrderEntity", "ShipVia", "SHIPVIA", true, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNonNullNumericConverter(), typeof(System.Int64), 13 );
		}
		...
		private void InitOrderDetailEntityMappings()
		{
			...
			this.AddElementFieldMapping( "OrderDetailEntity", "OrderId", "ORDERID", false, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNonNullNumericConverter(), typeof(System.Int64), 1 );
			this.AddElementFieldMapping( "OrderDetailEntity", "ProductId", "PRODUCTID", false, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNumericConverter(), typeof(System.Int64), 2 );
			this.AddElementFieldMapping( "OrderDetailEntity", "Quantity", "QUANTITY", false, "Decimal", 0, 0, 5, false, "",  new AW.Helper.TypeConverters.SmallIntegerNumericConverter(), typeof(System.Int32), 3 );
		...
		private void InitProductEntityMappings()
		{
			...
			this.AddElementFieldMapping( "ProductEntity", "ReorderLevel", "REORDERLEVEL", true, "Decimal", 0, 0, 5, false, "",  new AW.Helper.TypeConverters.SmallIntegerNumericConverter(), typeof(System.Int32), 5 );
			this.AddElementFieldMapping( "ProductEntity", "SupplierId", "SUPPLIERID", true, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNumericConverter(), typeof(System.Int64), 6 );
			this.AddElementFieldMapping( "ProductEntity", "UnitPrice", "UNITPRICE", true, "Decimal", 0, 4, 19, false, "", null, typeof(System.Decimal), 7 );
			this.AddElementFieldMapping( "ProductEntity", "UnitsInStock", "UNITSINSTOCK", true, "Decimal", 0, 0, 5, false, "",  new AW.Helper.TypeConverters.SmallIntegerNumericConverter(), typeof(System.Int32), 8 );
			this.AddElementFieldMapping( "ProductEntity", "UnitsOnOrder", "UNITSONORDER", true, "Decimal", 0, 0, 5, false, "",  new AW.Helper.TypeConverters.SmallIntegerNumericConverter(), typeof(System.Int32), 9 );
		}
		...
		private void InitRegionEntityMappings()
		{
			...
			this.AddElementFieldMapping( "RegionEntity", "RegionId", "REGIONID", false, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNonNullNumericConverter(), typeof(System.Int64), 1 );
		}
		...
		private void InitShipperEntityMappings()
		{
			...
			this.AddElementFieldMapping( "ShipperEntity", "ShipperId", "SHIPPERID", false, "Decimal", 0, 0, 10, true, "DBO_NORTHWIND.SHIPPERS_SHIPPERID_SEQ",  new AW.Helper.TypeConverters.IntegerNonNullNumericConverter(), typeof(System.Int64), 2 );
		}
		...
		private void InitSupplierEntityMappings()
		{
			...
			this.AddElementFieldMapping( "SupplierEntity", "SupplierId", "SUPPLIERID", false, "Decimal", 0, 0, 10, true, "DBO_NORTHWIND.SUPPLIERS_SUPPLIERID_SEQ",  new AW.Helper.TypeConverters.IntegerNonNullNumericConverter(), typeof(System.Int64), 11 );
		}
		...
		private void InitTerritoryEntityMappings()
		{
			...
			this.AddElementFieldMapping( "TerritoryEntity", "RegionId", "REGIONID", false, "Decimal", 0, 0, 10, false, "",  new AW.Helper.TypeConverters.IntegerNumericConverter(), typeof(System.Int64), 0 );
