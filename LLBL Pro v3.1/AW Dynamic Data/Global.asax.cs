		...
		public static void RegisterRoutes(RouteCollection routes)
		{
			...
			var modelProvider =
				new LLBLGenProDataModelProvider(
					...
					new LinqMetaData(), // <<<<< Replace 'YourRootNamespace' with the namespace you specified for Root namespace when you generated code
					new ElementCreator()); // <<<<< Replace 'YourRootNamespace' with the namespace you specified for Root namespace when you generated code
