...
namespace AW.Tests
{
	...
	public class MetaDataHelperTest
	{
		...
		{
			Assert.IsTrue(MetaDataHelper.IsSerializable(typeof(List<SerializableClass>)));
			...
			Assert.IsTrue(MetaDataHelper.IsSerializable(typeof(CustomerEntity)));
			Assert.IsTrue(MetaDataHelper.IsSerializable(typeof(AddressTypeEntity)));
			Assert.IsTrue(MetaDataHelper.IsSerializable(typeof(EntityCollection<CustomerEntity>)));
			//Assert.IsTrue(MetaDataHelper.IsSerializable(typeof(EntityCollection<AddressTypeEntity>)));
		}
