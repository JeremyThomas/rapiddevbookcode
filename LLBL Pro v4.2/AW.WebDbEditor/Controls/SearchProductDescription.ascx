<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchProductDescription.ascx.cs" Inherits="Controls_SearchProductDescription" %>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxDescriptionMiFrom" runat="server" maxlength="400" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
