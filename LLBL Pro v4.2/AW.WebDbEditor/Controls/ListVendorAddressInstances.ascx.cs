...
public partial class Controls_ListVendorAddressInstances : System.Web.UI.UserControl, IListControl
{
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
		...
		// export to excel
        GridViewExportUtils.Export("VendorAddress.xls", theGrid);
    }
	...
	protected void theGrid_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		...
		VendorAddressEntity selectedEntity = (VendorAddressEntity)_VendorAddressDS.EntityCollection[index];
		...
		{
			case "EditExisting":
				Response.Redirect("~/EditExisting.aspx?EntityType=" + (int)EntityType.VendorAddressEntity + pkFieldsAndValues.ToString());
				break;
			case "ViewExisting":
				Response.Redirect("~/ViewExisting.aspx?EntityType=" + (int)EntityType.VendorAddressEntity + pkFieldsAndValues.ToString());
				break;
		}
	}
