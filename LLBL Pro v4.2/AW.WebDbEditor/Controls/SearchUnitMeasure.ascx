<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchUnitMeasure.ascx.cs" Inherits="Controls_SearchUnitMeasure" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxUnitMeasureCode" runat="server" maxlength="3" size="3" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>   <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqUnitMeasureCode" runat="server" ControlToValidate="tbxUnitMeasureCode" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
