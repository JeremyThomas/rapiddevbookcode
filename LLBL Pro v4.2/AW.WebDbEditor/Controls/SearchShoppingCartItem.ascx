<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchShoppingCartItem.ascx.cs" Inherits="Controls_SearchShoppingCartItem" %>
...
<table cellpadding="3" border="0" cellspacing="1" class="formtexts">
	...
	<tr>
		...
		<td class="content">
			<asp:textbox id="tbxShoppingCartItemID" runat="server" maxlength="11" size="11" Text="" ValidationGroup="PkSearchValidation"  CssClass="required"/>  <asp:RangeValidator ID="valShoppingCartItemID" runat="server" ControlToValidate="tbxShoppingCartItemID" ValidationGroup="PkSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/> <asp:RequiredFieldValidator ValidationGroup="PkSearchValidation" ID="reqShoppingCartItemID" runat="server" ControlToValidate="tbxShoppingCartItemID" Display="Dynamic" ErrorMessage="Required" />
		</td>
		<td width="20" nowrap="nowrap" class="content">&nbsp;</td>
	</tr>
	<tr>
...
<table cellpadding="2" border="0" cellspacing="0" class="formtexts">
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableDateCreated" runat="server" /></td>
		<td class="formtexts tableborder">
			DateCreated:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotDateCreated" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opDateCreated" runat="server">
		...
		<td class="content" tableborder" nowrap="nowrap">
			<cc:datetextbox id="dtxDateCreatedMiFrom" runat="server" Required="False" ValidationGroup="SubSetSearchValidation" /> 
			and
			<cc:datetextbox id="dtxDateCreatedMiTo" runat="server" Required="False" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableShoppingCartID" runat="server" /></td>
		<td class="formtexts tableborder">
			ShoppingCartID:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotShoppingCartID" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opShoppingCartID" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxShoppingCartIDMiFrom" runat="server" maxlength="50" size="25" Text="" ValidationGroup="SubSetSearchValidation" /> 
		</td>
	</tr>
	<tr>
		<td width="20" class="content tableborder" style="border-left:none;"><asp:CheckBox ID="chkEnableShoppingCartItemID" runat="server" /></td>
		<td class="formtexts tableborder">
			ShoppingCartItemID:
		</td>
		<td class="content tableborder">
			<asp:CheckBox ID="chkNotShoppingCartItemID" runat="server" />
		</td>
		<td class="content tableborder">
			<asp:DropDownList ID="opShoppingCartItemID" runat="server">
				<asp:ListItem Value="0" Selected="True" Text="Equal"/>
				<asp:ListItem Value="1" Text="Greater"/>
				<asp:ListItem Value="2" Text="Greater / Equal"/>
				<asp:ListItem Value="3" Text="Lesser"/>
		...
		<td class="content" tableborder" nowrap="nowrap">
			<asp:textbox id="tbxShoppingCartItemIDMiFrom" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiShoppingCartItemIDMiFrom" runat="server" ControlToValidate="tbxShoppingCartItemIDMiFrom" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
			and
			<asp:textbox id="tbxShoppingCartItemIDMiTo" runat="server" maxlength="11" size="11" Text="" ValidationGroup="SubSetSearchValidation" /> <asp:RangeValidator ID="valMiShoppingCartItemIDMiTo" runat="server" ControlToValidate="tbxShoppingCartItemIDMiTo" ValidationGroup="SubSetSearchValidation" Display="dynamic" ErrorMessage="Valor no valido" MinimumValue="-2147483648" MaximumValue="2147483647" Type="integer"/>
		</td>
	</tr>
	<tr>
		<td colspan="2" nowrap="nowrap" class="content">&nbsp;</td>
