...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListVendorInstancesReport.ascx.cs" Inherits="Controls_ListVendorInstancesReport" %>
...
<rsweb:ReportViewer ID="theReportViewer" runat="server" Width="100%"  SizeToReportContent="true">
    <LocalReport ReportPath= "Reports\\VendorReport.rdlc">
        <DataSources>
            <rsweb:ReportDataSource DataSourceId="_VendorDS" Name="Vendor" />
        </DataSources>
    </LocalReport>
</rsweb:ReportViewer> 
