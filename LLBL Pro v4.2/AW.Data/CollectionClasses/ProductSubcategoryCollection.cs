...
namespace AW.Data.CollectionClasses
{
	...
	public partial class ProductSubcategoryCollection : EntityCollectionBase<ProductSubcategoryEntity>
	{
		...
		public ProductSubcategoryCollection(IEnumerable<ProductSubcategoryEntity> initialContents):base(new ProductSubcategoryEntityFactory())
		{
		...
		{
			return GetMultiManyToOne(productCategoryInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(productCategoryInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, filter, 0, 0);
		}
		...
		public virtual bool GetMultiManyToOne(IEntity productCategoryInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateProductSubcategoryDAO().GetMulti(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, filter, productCategoryInstance, pageNumber, pageSize);
		}
		...
		{
			return DAOFactory.CreateProductSubcategoryDAO().DeleteMulti(this.Transaction, productCategoryInstance);
		}
		...
		{
			return DAOFactory.CreateProductSubcategoryDAO().UpdateMulti(entityWithNewValues, this.Transaction, productCategoryInstance);
		}

		/// <summary> Retrieves in this ProductSubcategoryCollection object all ProductSubcategoryEntity objects which are related via a  Relation of type 'm:n' with the passed in ProductModelEntity. All current elements in the collection are removed from the collection.</summary>
		...
		public virtual bool GetMultiManyToManyUsingModels(IEntity productModelInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateProductSubcategoryDAO().GetMultiUsingModels(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, productModelInstance, null, pageNumber, pageSize);
		}
		...
		public bool GetMultiManyToManyUsingModels(IEntity productModelInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			...
			return DAOFactory.CreateProductSubcategoryDAO().GetMultiUsingModels(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, productModelInstance, prefetchPathToUse, 0, 0);
		}
		...
		public virtual object GetScalar(ProductSubcategoryFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
			...
			return DAOFactory.CreateProductSubcategoryDAO().GetScalar(fields, this.Transaction, filter, relations, groupByClause);
		}
