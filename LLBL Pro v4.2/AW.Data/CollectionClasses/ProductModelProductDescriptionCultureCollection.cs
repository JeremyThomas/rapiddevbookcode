...
namespace AW.Data.CollectionClasses
{
	...
	public partial class ProductModelProductDescriptionCultureCollection : EntityCollectionBase<ProductModelProductDescriptionCultureEntity>
	{
		...
		public ProductModelProductDescriptionCultureCollection(IEnumerable<ProductModelProductDescriptionCultureEntity> initialContents):base(new ProductModelProductDescriptionCultureEntityFactory())
		{
		...
		{
			return GetMultiManyToOne(cultureInstance, productDescriptionInstance, productModelInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(cultureInstance, productDescriptionInstance, productModelInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, filter, 0, 0);
		}
		...
		public virtual bool GetMultiManyToOne(IEntity cultureInstance, IEntity productDescriptionInstance, IEntity productModelInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateProductModelProductDescriptionCultureDAO().GetMulti(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, filter, cultureInstance, productDescriptionInstance, productModelInstance, pageNumber, pageSize);
		}
		...
		{
			return DAOFactory.CreateProductModelProductDescriptionCultureDAO().DeleteMulti(this.Transaction, cultureInstance, productDescriptionInstance, productModelInstance);
		}
		...
		{
			return DAOFactory.CreateProductModelProductDescriptionCultureDAO().UpdateMulti(entityWithNewValues, this.Transaction, cultureInstance, productDescriptionInstance, productModelInstance);
		}
		...
		public virtual object GetScalar(ProductModelProductDescriptionCultureFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
			...
			return DAOFactory.CreateProductModelProductDescriptionCultureDAO().GetScalar(fields, this.Transaction, filter, relations, groupByClause);
		}
