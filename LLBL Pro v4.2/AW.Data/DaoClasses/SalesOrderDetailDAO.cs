...
namespace AW.Data.DaoClasses
{
	...
	/// <summary>General DAO class for the SalesOrderDetail Entity. It will perform database oriented actions for a entity of type 'SalesOrderDetailEntity'.</summary>
	public partial class SalesOrderDetailDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public SalesOrderDetailDAO() : base(InheritanceHierarchyType.None, "SalesOrderDetailEntity", new SalesOrderDetailEntityFactory())
		{
		}



		/// <summary>Retrieves in the calling SalesOrderDetailCollection object all SalesOrderDetailEntity objects which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter. </summary>
