		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncIllustration(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _illustration, new PropertyChangedEventHandler( OnIllustrationPropertyChanged ), "Illustration", AW.Data.RelationClasses.StaticProductModelIllustrationRelations.IllustrationEntityUsingIllustrationIDStatic, true, ref _alreadyFetchedIllustration, new string[] {  } );
			}
		}
		...
		private void SetupSyncProductModel(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _productModel, new PropertyChangedEventHandler( OnProductModelPropertyChanged ), "ProductModel", AW.Data.RelationClasses.StaticProductModelIllustrationRelations.ProductModelEntityUsingProductModelIDStatic, true, ref _alreadyFetchedProductModel, new string[] {  } );
			}
		}
