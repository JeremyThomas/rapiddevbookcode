...
namespace AW.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public CountryRegionCurrencyEntity(System.String countryRegionCode, System.String currencyCode, IPrefetchPath prefetchPathToUse):base("CountryRegionCurrencyEntity")
		{
		...
		private void SetupSyncCountryRegion(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _countryRegion, new PropertyChangedEventHandler( OnCountryRegionPropertyChanged ), "CountryRegion", AW.Data.RelationClasses.StaticCountryRegionCurrencyRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, ref _alreadyFetchedCountryRegion, new string[] {  } );
			}
		}
		...
		private void SetupSyncCurrency(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _currency, new PropertyChangedEventHandler( OnCurrencyPropertyChanged ), "Currency", AW.Data.RelationClasses.StaticCountryRegionCurrencyRelations.CurrencyEntityUsingCurrencyCodeStatic, true, ref _alreadyFetchedCurrency, new string[] {  } );
			}
		}
