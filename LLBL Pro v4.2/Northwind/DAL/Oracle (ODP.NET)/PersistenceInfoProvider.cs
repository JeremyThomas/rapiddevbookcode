...
namespace Northwind.DAL.Oracle
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitCategoryEntityMappings()
		{
			...
			this.AddElementFieldMapping("CategoryEntity", "CategoryId", "CATEGORYID", false, "Decimal", 0, 10, 0, false, "", new AW.Helper.TypeConverters.IntegerNumericConverter(), typeof(System.Int64), 0);
